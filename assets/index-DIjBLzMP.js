...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:yn,depthTest:!1,depthWrite:!1})}function B0(i,e,t){const n=new Float32Array(pi),s=new M(0,1,0);return new Vt({name:"SphericalGaussianBlur",defines:{n:pi,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:Dr(),fragmentShader:`
		...
		`,blending:yn,depthTest:!1,depthWrite:!1})}function Ic(){return new Vt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Dr(),fragmentShader:`
		...
		`,blending:yn,depthTest:!1,depthWrite:!1})}function Nc(){return new Vt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Dr(),fragmentShader:`
...
`)}function Vm(i,e){let t;switch(e){case ah:t="Linear";break;case oh:t="Reinhard";break;case ch:t="Cineon";break;case lh:t="ACESFilmic";break;case hh:t="AgX";break;case dh:t="Neutral";break;case uh:t="Custom";break;default:Pe("WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const lr=new M;function Hm(){Ye.getLuminanceCoefficients(lr);const i=lr.x.toFixed(4),e=lr.y.toFixed(4),t=lr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`;const ru=window.matchMedia("(prefers-reduced-motion: reduce)").matches;document.body.classList.toggle("is-track-edit-mode",ts);const rg=document.querySelector("#command-canvas"),fo=document.querySelector(".hero");document.querySelector(".hero-copy");const va=document.querySelector(".focus-drawer"),ag=document.querySelector(".focus-content"),og=document.querySelector(".focus-close"),Mr=document.querySelector(".modal-dismiss-layer"),Tt=document.querySelector(".cyber-modal"),jn=document.querySelector(".active-panel-dock"),cg=document.querySelector(".track-reset-view");document.querySelector(".track-edit-panel");const sl=document.querySelector(".track-edit-selected"),ms=document.querySelector(".track-edit-copy"),au=Array.from(document.querySelectorAll("[data-track-edge]")),ou={mission:{kicker:"ARMADA OVERVIEW / VALUE / BUSINESS / MISSION",title:"ARMADAの全体像",body:"大学・研究機関の研究シーズを、事業会社として動くDeepTech Startupへ変える。ARMADAは助言者ではなく、会社化前の設計、創業、資金調達、採用、経営参画までを担うスタートアップスタジオです。",points:["Before Zero Theory","ARMADA Protocol","Company Creation","Management Execution"],type:"mission"},deck:{kicker:"BUSINESS / WHAT WE DO",title:"DeepTech Startupを、創る。支える。新しい事業へ変える。",body:"team ARMADAは、研究の結晶である技術シーズに、成長戦略と実行力、そして日本のものづくり力をかけ合わせ、スタートアップとして量産するディープテック特化型の事業化スタジオです。",points:["Startup Creation","Startup Support","New Business Creation","Before 0から0→1まで"]},value:{kicker:"VALUE ENGINE / BEFORE ZERO THEORY / ARMADA PROTOCOL",title:"会社になる前の空白を、事業化できる仕組みに変える。",body:"Before Zero Theoryは、研究シーズが会社になる前に止まる空白を設計対象にする考え方。ARMADA Protocolは、その実践知を分岐点、判断材料、アクション、結果と学習として構造化し、次の事業化判断へ戻す仕組みです。",points:["Before Zero Theory","ARMADA Protocol","ARMADA OS","What / Why / How / Result"]},track:{kicker:"PORTFOLIO / TRACK RECORD",title:"大学・研究機関の技術を、DeepTech Startupへ。",body:"JOYCLE、LiSTie、Blue Water Energy、CrestecBio、ティエムファクトリ、Yellow Duckなど、公開可能なポートフォリオと実績を地図上のビーコンとして表示します。",points:["22 PJ / DTSU創出・支援","32億円+ / 累計資金調達","30億円+ / 助成金獲得","全省庁入札資格"]},news:{kicker:"SIGNAL LOG / NEWS",title:"公開実績とニュース。",body:"受賞、メディア掲載、自治体連携、採択情報など、現行サイトで公開しているニュースをHUDログとして表示します。",points:["Award","Media","Press","Public Funding"],type:"news"},members:{kicker:"MEMBERS / CODE NAME / PROFILE",title:"技術と事業をつなぎ、創業前から経営に入る実行チーム。",body:"研究、事業開発、MOT、知財、採用、組織づくり、広報、バックオフィスまで。DeepTech Startupの立ち上げと経営実行に必要な専門性を、ひとつのチームとして束ねています。",points:["KIYO","MASA","CHIKO","RAN","HARU","LILY","KARU","KOU","UME","ABI","KANA"],type:"members"},contact:{kicker:"CONTACT / COMPANY PROFILE",title:"研究シーズの事業化を、一緒に始める。",body:"株式会社チームアルマダ。茨城県つくば市吾妻1-10-1。2018年1月30日設立。DeepTech Startupの創出・経営、スタートアップスタジオ運営、研究機関発技術の事業化支援を行います。",points:["名前","ふりがな","会社名・団体名","メールアドレス","電話番号","投資家・VC / 企業 / メディア / その他"]}},lg=[{category:"JOYCLE",date:"2025.11.18",title:"【JOYCLE】中部ニュービジネス協議会 最優秀賞受賞",url:"https://team-armada.jp/%e3%80%90joycle%e3%80%91%e4%b8%ad%e9%83%a8%e3%83%8b%e3%83%a5%e3%83%bc%e3%83%93%e3%82%b8%e3%83%8d%e3%82%b9%e5%8d%94%e8%ad%b0%e4%bc%9a-%e6%9c%80%e5%84%aa%e7%a7%80%e8%b3%9e%e5%8f%97%e8%b3%9e/",image:"/assets/news/team-armada-news.png"},{category:"JOYCLE",date:"2025.10.19",title:"JOYCLE、「週刊東洋経済」特集『すごいベンチャー100（2025年最新版）』に選出",url:"https://team-armada.jp/joycle%e3%80%81%e3%80%8c%e9%80%b1%e5%88%8a%e6%9d%b1%e6%b4%8b%e7%b5%8c%e6%b8%88%e3%80%8d%e7%89%b9%e9%9b%86%e3%80%8e%e3%81%99%e3%81%94%e3%81%84%e3%83%99%e3%83%b3%e3%83%81%e3%83%a3%e3%83%bc100%ef%bc%8820/",image:"/assets/news/joycle-toyokeizai-2025.png"},{category:"Blue Water Energy",date:"2025.10.19",title:"【Blue Water Energy】StartupGo!Go! The Pitch ファイナル進出＆西武ガスHD賞 受賞",url:"https://team-armada.jp/%e3%80%90blue-water-energy%e3%80%91startupgogo-the-pitch-%e3%83%95%e3%82%a1%e3%82%a4%e3%83%8a%e3%83%ab%e9%80%b2%e5%87%ba%ef%bc%86%e8%a5%bf%e6%ad%a6%e3%82%ac%e3%82%b9hd%e8%b3%9e-%e5%8f%97%e8%b3%9e/",image:"/assets/news/bwe-startupgogo-2025.jpg"},{category:"Blue Water Energy",date:"2025.09.05",title:"【Blue Water Energy】宇部市との合同記者会見を開催",url:"https://team-armada.jp/%e3%80%90blue-water-energy%e3%80%91%e5%ae%87%e9%83%a8%e5%b8%82%e3%81%a8%e3%81%ae%e5%90%88%e5%90%8c%e8%a8%98%e8%80%85%e4%bc%9a%e8%a6%8b%e3%82%92%e9%96%8b%e5%82%ac/",image:"/assets/news/bwe-ube-press-2025.png"},{category:"TEAM ARMADA",date:"2025.09.01",title:"【team ARMADA】コーポレートサイトをリニューアルしました。",url:"https://team-armada.jp/%e3%80%90team-armada%e3%80%91%e3%82%b3%e3%83%bc%e3%83%9d%e3%83%ac%e3%83%bc%e3%83%88%e3%82%b5%e3%82%a4%e3%83%88%e3%82%92%e3%83%aa%e3%83%8b%e3%83%a5%e3%83%bc%e3%82%a2%e3%83%ab%e3%81%97%e3%81%be%e3%81%97/",image:"/assets/news/team-armada-news.png"},{category:"Blue Water Energy",date:"2025.07.17",title:"【Blue Water Energy】宇部市のスタートアップ支援補助金の採択事業に認定されました！",url:"https://team-armada.jp/%e5%ae%87%e9%83%a8%e5%b8%82%e3%81%ae%e3%82%b9%e3%82%bf%e3%83%bc%e3%83%88%e3%82%a2%e3%83%83%e3%83%97%e6%94%af%e6%8f%b4%e8%a3%9c%e5%8a%a9%e9%87%91%e3%81%ae%e6%8e%a1%e6%8a%9e%e4%ba%8b%e6%a5%ad%e3%81%ab/",image:"/assets/news/team-armada-news.png"}],cu=[{code:"KIYO",name:"肥塚 恭子",kana:"こえづか きょうこ",role:"Manager",image:ht("/assets/members/kiyo-photo.jpg"),bio:"セブンイレブン、飲食店数店、セントラル子供タレント、耐震構造計算設計事務所を経て、ティエムファクトリに7年在籍。その後チームアルマダへ。",skill:"場の雰囲気を盛り上げること、ものまね、掃除、植物を育てること"},{code:"MASA",name:"山地 正洋",kana:"やまじ まさひろ",role:"CEO / Founder",image:ht("/assets/members/masa-photo.jpg"),bio:"慶應義塾大学博士号取得。NIMS、産総研、京都大学等で研究に従事。京大発SU設立、9年間経営後、CxOを多数兼任しチームアルマダを結成。",skill:"旗を振ること、みんなを巻き込むこと"},{code:"CHIKO",name:"遠藤 千穂",kana:"えんどう ちほ",role:"Senior Associate",image:ht("/assets/members/chiko-photo.jpg"),bio:"お茶の水女子大学理学部化学科卒業、同大学大学院ライフサイエンス専攻修了後、製薬メーカーで新薬開発に従事。現在はアルマダでMOT（技術経営）業務を務めるほか、咲き編みアーティストとしてブランドを主宰。",skill:"MOT（技術経営）と研究シーズの事業化支援"},{code:"RAN",name:"深山 蘭",kana:"ふかやま らん",role:"Senior Associate",image:ht("/assets/members/ran-photo.jpg"),bio:"東京大学大学院修了後、産総研で11年間、法務・知財・研究支援業務に従事。熊本大学発ベンチャーCASTに3人目社員として参画し取締役COOを務める。",skill:"公的資金管理と社内制度設計"},{code:"HARU",name:"中井 遥",kana:"なかい はるか",role:"PM / Operations",image:ht("/assets/members/haru-photo.jpg"),bio:"筑波大学体育専門学群卒業後、しびっくぱわーで自治体受託事業やアクセラプログラムの企画運営、採用、新規事業開発を担当。Gattoを起業。",skill:"目的達成に向けて環境を整え、道筋を明確化すること"},{code:"LILY",name:"藤崎 百合恵",kana:"ふじさき ゆりえ",role:"MOT / IP Strategy",image:ht("/assets/members/riri-photo.jpg"),bio:"総合電機メーカーでプラント設計に従事後、NIMSで契約、渉外、知財戦略、研究成果PRを担当。NIMS発スタートアップの創業前からアーリー期を支援。",skill:"複雑なテーマを整理して、次の一歩を明確にすること"},{code:"KARU",name:"輕部 琢真",kana:"かるべ たくま",role:"Strategy",image:ht("/assets/members/karu-photo.jpg"),bio:"東京大学、トヨタ自動車、A.T. Kearney、不動産系スタートアップなどを経てアルマダへ。",skill:"業界・技術のキャッチアップ、ディープテックSUの戦略立案・運営"},{code:"KOU",name:"宮崎 航一",kana:"みやざき こういち",role:"Business Development",image:ht("/assets/members/kou-photo.jpg"),bio:"三重県出身。東京大学経済学部で経営戦略を専攻。トヨタ自動車を経て、創業期のLabBaseで科学技術領域の新規事業立ち上げやアジア展開を経験。",skill:"科学技術領域の新規事業立ち上げ"},{code:"UME",name:"梅本 隆司",kana:"うめもと りゅうじ",role:"Recruiting / PM",image:ht("/assets/members/ume-photo.jpg"),bio:"大手ドラッグストア、飲食業界、人材業界、飲食業界特化の人事コンサル会社を経て独立。多数のスタートアップに採用支援として参画。",skill:"仕組み化と効率化、人の懐に入り込むこと、採用における大体のこと"},{code:"ABI",name:"安孫子 芽生",kana:"あびこ めい",role:"Organization / PM",image:ht("/assets/members/abi-photo.jpg"),bio:"広告代理店で人事企画・戦略を経験後、コンサル業界、人材業界で人事、事業推進、広報、経営企画など組織づくり全般を担当。",skill:"曖昧な要素を言語化・可視化すること、誰とでも仲良くなること"},{code:"KANA",name:"夏目 奏",kana:"なつめ かな",role:"Communication / Design",image:ht("/assets/members/kana-photo.jpg"),bio:"北大大学院修了。航空会社、国立極地研究所、SaaS系スタートアップを経てアルマダへ。広報、Webコンテンツ制作、紙媒体デザイン等を担う。",skill:"複雑な情報をわかりやすく伝える・届けること"}],gi={home:{position:new M(.35,14.5,13.5),lookAt:new M(.65,-1.08,.35),zoom:72},mission:{position:new M(-3.8,5.5,8.7),lookAt:new M(-3.8,.6,-1.4)},deck:{position:new M(2.2,5,7.6),lookAt:new M(.6,-.75,.4)},value:{position:new M(4.8,4.8,6.8),lookAt:new M(2.5,.6,-1.2)},track:{position:new M(3.05,33.8,.45),lookAt:new M(3.05,-1.58,.45),zoom:52},news:{position:new M(-3.8,5.5,8.7),lookAt:new M(-3.8,.6,-1.4)},contact:{position:new M(-.8,4.8,7.2),lookAt:new M(1.6,-.6,-3.6)}},rl=new M(-5,2.5,4.35),al=new qt(0,0,0),mt={active:!1,startTime:0,duration:2500,startPosition:new M,startLookAt:new M,startZoom:gi.home.zoom,position:new M,lookAt:new M,zoom:gi.home.zoom};let st="home",po=!1,sn={x:0,y:0,rx:0,ry:0,hitKey:null,moved:!1},Ki=0;const nn={x:0,y:0},Sn={x:0,y:0},lu=new Map,uu=new Map,hu=[],du=[],ji=[],Cs=[],bs=[],An=[],ug=!0,ei=new M(3.05,-1.58,.45),ii={width:50.0625,height:28.265625},Ma=new Map;function wn(i){return Number(i).toFixed(5)}function fu(i){return i.map(e=>`${wn(e.x)},${wn(e.y)},${wn(e.z)}`).join("|")}function ns(i,e){return Ma.has(i)||Ma.set(i,e()),Ma.get(i)}function Mi(i,e,t=1,n=1){return ns(`plane:${wn(i)}:${wn(e)}:${t}:${n}`,()=>new Is(i,e,t,n))}function pu(i,e){return ns(`circle:${wn(i)}:${e}`,()=>new Po(i,e))}function hg(i,e,t){return ns(`sphere:${wn(i)}:${e}:${t}`,()=>new Uo(i,e,t))}function dg(i,e,t=8,n=1,s=!0){return ns(`cylinder:${wn(i)}:${wn(e)}:${t}:${n}:${s}`,()=>new Do(i,i,e,t,n,s))}function fg(i){return ns(`line:${fu(i)}`,()=>new Ot().setFromPoints(i.map(e=>e.clone())))}function mu(i,e,t){return ns(`tube:${e}:${wn(t)}:${fu(i)}`,()=>new Io(new Wl(i.map(n=>n.clone()),!1,"catmullrom",0),e,t,8,!1))}function pg(i){return bu.find(e=>e.key===i)}function mg(i){const e=pg(i),t={news:{eyebrow:"SIGNAL LOG",title:"NEWS",body:"Award / Media / Press"}}[i];if(i==="track"||e?.plane==="ground"||!e&&!t)return"";const n=e??t;return`
  ...
  `;const t=`
    ...
    <h2>${e.title}</h2>
  `,n=mg(i);if(jn.innerHTML=n,jn.classList.toggle("is-open",!!n),e.type==="members"){Tt.className="cyber-modal cyber-modal-members",Tt.innerHTML=`
      ${t}
      <p>${e.body}</p>
...
`));return`mailto:info@team-armada.jp?subject=${t}&body=${n}`}Tt.addEventListener("submit",async i=>{const e=i.target;if(!(e instanceof HTMLFormElement)||!e.classList.contains("contact-form"))return;i.preventDefault();const t=e.querySelector(".terminal-transmit"),n=e.querySelector(".terminal-feedback"),s=new FormData(e);if(!s.get("_honey")){t&&(t.disabled=!0),n&&(n.textContent="TRANSMITTING...");try{const r=await fetch(e.action,{method:"POST",headers:{Accept:"application/json"},body:s});if(!r.ok)throw new Error(`Contact request failed: ${r.status}`);e.reset(),n&&(n.textContent="送信しました。ARMADAから折り返します。")}catch(r){console.warn(r),n&&(n.textContent="送信経路をメールに切り替えます。"),window.location.href=vg(s)}finally{t&&(t.disabled=!1)}}});function xu(i){if(st==="home"||Date.now()<Ki)return;const e=i.target;if(e instanceof Element){if(st==="track"){if(ts||e.closest(".track-site-card, .track-reset-view, .track-edit-panel, .track-anchor-handle, .track-card-handle"))return}else if(e.closest(".cyber-modal, .active-panel-dock, .focus-close, .nav, .screen-hud-cards, .track-summary-panel, .track-reset-view, .track-edit-panel, .track-anchor-handle, .track-card-handle"))return;i.preventDefault(),i.stopImmediatePropagation(),Ki=Date.now()+260,an("home")}}document.addEventListener("pointerdown",xu,!0);document.addEventListener("click",xu,!0);window.addEventListener("keydown",i=>{i.key==="Escape"&&an("home")});const cl=ts?"track":su.get("focus");ou[cl]&&window.setTimeout(()=>an(cl),250);const is=new kl;is.fog=new wo(132875,.035);const gu=new kl,dt=new Jt(66,window.innerWidth/window.innerHeight,.1,120);dt.position.copy(gi.home.position);dt.lookAt(gi.home.lookAt);const Cn=new Lx({canvas:rg,antialias:!0,alpha:!0,powerPreference:"high-performance"});Cn.setClearColor(132875,1);Cn.setClearAlpha(0);Cn.setPixelRatio(Math.min(window.devicePixelRatio,1.7));Cn.setSize(window.innerWidth,window.innerHeight);const _i=new tg(Cn);_i.setPixelRatio(Math.min(window.devicePixelRatio,1.7));_i.setSize(window.innerWidth,window.innerHeight);_i.addPass(new ng(is,dt));const Mg=new $i(new oe(window.innerWidth,window.innerHeight),.95,.56,.55);_i.addPass(Mg);const on=new Nx;on.setSize(window.innerWidth,window.innerHeight);on.domElement.className="css3d-layer";fo.appendChild(on.domElement);on.domElement.firstElementChild.style.pointerEvents="auto";const Nt=new Ox(dt,on.domElement);Nt.enabled=ug;Nt.enableDamping=!0;Nt.dampingFactor=.08;Nt.rotateSpeed=.62;Nt.zoomSpeed=.78;Nt.panSpeed=.55;Nt.minDistance=3.8;Nt.maxDistance=48;Nt.target.copy(gi.home.lookAt);Nt.update();const ll=new Kl,ul=new oe(0,0),hl=new Gd,dl=new oe,fl=new On(new M(0,1,0),1.2),vt=new mn;is.add(vt);const Zi=new mn;gu.add(Zi);is.add(new Vd(7334143,.95));const _u=new ql(2815999,5.4,32);_u.position.set(0,4.5,1.4);is.add(_u);const vu=new ql(16765286,1.1,18);vu.position.set(-5,3,-2);is.add(vu);function bg({key:i,eyebrow:e,title:t,body:n,stats:s,scan:r}){const a=document.createElement("button");a.type="button",a.className=`deck-card deck-card-${i}`,a.dataset.focus=i,a.setAttribute("aria-label",`${t}を開く`);const o=r?`<span class="scan-tag">${r}</span>`:"";return i==="mission"?a.innerHTML=`
    ...
    `,a.addEventListener("click",c=>{if(c.stopImmediatePropagation(),!(Date.now()<Ki)){if(st!=="home"){an("home");return}an(i)}}),a}function Sg(i){const e=new Fo(bg(i)),t=new M(...i.position),n=new qt(...i.rotation),s=i.scale??.012;return e.position.copy(t),e.rotation.copy(n),e.scale.setScalar(s),e.userData={key:i.key,plane:i.plane??"vertical",basePosition:t,baseRotation:n,baseScale:s,focusPosition:t.clone().add(new M(0,.15,1.15)),focusScale:s*1.18},Zi.add(e),lu.set(i.key,e),e}function ki(i,e){const t=Math.min(i,e)*.12;return[new M(-i/2+t,e/2,0),new M(i/2-t*.55,e/2,0),new M(i/2,e/2-t*.55,0),new M(i/2,-e/2+t,0),new M(i/2-t,-e/2,0),new M(-i/2+t*.45,-e/2,0),new M(-i/2,-e/2+t*.45,0),new M(-i/2,e/2-t,0),new M(-i/2+t,e/2,0)]}function Lt(i,e,t,n,s,r){const a=new gt(Mi(t,n),new Ht({color:new Ne(s).multiplyScalar(1.45),transparent:!0,opacity:r,blending:Ft,depthTest:!1,depthWrite:!1,side:bt}));return a.position.set(i,e,.018),a.userData.baseOpacity=r,a.userData.kind="bar",a}function Rt(i,e=2815999,t=.56){const n=new zl(fg(i),new Co({color:new Ne(e).multiplyScalar(1.25),transparent:!0,opacity:t,blending:Ft,depthWrite:!1}));return n.userData.baseOpacity=t,n}function Zn(i,e=2815999,t=.72,n=.012){const s=new gt(mu(i,Math.max(8,i.length*10),n),new Ht({color:new Ne(e).multiplyScalar(2.15),transparent:!0,opacity:t,blending:Ft,depthTest:!1,depthWrite:!1,side:bt}));return s.userData.baseOpacity=t,s.userData.kind="rail",s}function Mu(i,e,t=2815999,n=.72,s=.01){const r=e.clone().sub(i),a=r.length(),o=new gt(dg(s,a,8,1,!0),new Ht({color:new Ne(t).multiplyScalar(2.2),transparent:!0,opacity:n,blending:Ft,depthTest:!1,depthWrite:!1,side:bt}));return o.position.copy(i).add(e).multiplyScalar(.5),o.quaternion.setFromUnitVectors(new M(0,1,0),r.normalize()),o.userData.baseOpacity=n,o.userData.kind="connector",o}function pl(i,e=2815999,t=.72,n=.01){const s=new mn;for(let r=0;r<i.length-1;r+=1)s.add(Mu(i[r],i[r+1],e,t,n));return s.userData.baseOpacity=t,s.userData.kind="segmented-rail",s.userData.color=e,s.userData.radius=n,s}function ml(i,e,t,n,s){i.children.forEach(r=>{r.geometry?.dispose(),r.material?.dispose()}),i.clear();for(let r=0;r<e.length-1;r+=1)i.add(Mu(e[r],e[r+1],t,n,s));i.userData.baseOpacity=n,i.userData.color=t,i.userData.radius=s}function vn(i,e,t,n,s){const r=new gt(pu(t,24),new Ht({color:new Ne(n).multiplyScalar(1.8),transparent:!0,opacity:s,blending:Ft,depthWrite:!1,side:bt}));return r.position.set(i,e,.026),r.userData.baseOpacity=s,r.userData.kind="light",r}function fs(i,e=96){const t=[];for(let n=0;n<=e;n+=1){const s=Math.PI*2*n/e;t.push(new M(Math.cos(s)*i,Math.sin(s)*i,0))}return t}function xl(i,e){const t=i*.18,n=i*.22;return[new M(-i/2+t,e/2,0),new M(-n/2,e/2,0),new M(-n/2+i*.03,e/2-e*.035,0),new M(n/2-i*.03,e/2-e*.035,0),new M(n/2,e/2,0),new M(i/2-t,e/2,0),new M(i/2,e/2-t,0),new M(i/2,-e/2+t,0),new M(i/2-t,-e/2,0),new M(-i/2+t,-e/2,0),new M(-i/2,-e/2+t,0),new M(-i/2,e/2-t,0),new M(-i/2+t,e/2,0)]}function yg(i,e){return[new M(-i/2,e*.22,0),new M(-i*.36,e*.34,0),new M(i*.42,e*.34,0),new M(i/2,e*.18,0),new M(i*.44,-e*.28,0),new M(-i*.42,-e*.28,0),new M(-i/2,-e*.12,0),new M(-i/2,e*.22,0)]}function Eg(i,e){return[new M(-i*.2,e*.18,0),new M(i*.2,e*.18,0),new M(i*.42,-e*.18,0),new M(i*.28,-e*.5,0),new M(-i*.28,-e*.5,0),new M(-i*.42,-e*.18,0),new M(-i*.2,e*.18,0)]}function hr(i,e,t,n=36){const s=[];for(let r=0;r<=n;r+=1){const a=e+(t-e)*r/n;s.push(new M(Math.cos(a)*i,Math.sin(a)*i,0))}return s}function gl(i,e,t,n,s,r,a=.024){for(let o=0;o<t;o+=1){const c=Math.PI*2*o/t,l=e-n*(o%5===0?1.8:1),u=e,d=Rt([new M(Math.cos(c)*l,Math.sin(c)*l,a),new M(Math.cos(c)*u,Math.sin(c)*u,a)],s,o%5===0?r:r*.48);i.add(d)}}function Tg(i,e){return{mission:[e*430,e*300],deck:[e*520,e*230],value:[e*300,e*300],track:[e*390,e*250],members:[e*360,e*220],contact:[e*208,e*208]}[i.key]??[e*340,e*(i.stats?220:176)]}function Ag(i){if(i.key==="contact")return null;const e=new M(...i.position),t=new qt(...i.rotation),n=i.scale??.012,[s,r]=Tg(i,n),a=new mn;let o=ki(s,r);i.key==="mission"||i.key==="value"?o=fs(Math.min(s,r)*.49,120):i.key==="contact"?o=xl(s,r):i.key==="deck"&&(o=yg(s,r));const c=i.key==="value"||i.key==="mission"?pu(Math.min(s,r)*.46,80):Mi(s*.96,r*.9),l=new gt(c,new Ht({color:204595,transparent:!0,opacity:i.key==="members"?0:i.key==="deck"?.12:.34,blending:Ft,depthWrite:!1,side:bt}));if(l.position.z=-.006,l.userData.baseOpacity=l.material.opacity,a.add(l),i.key!=="members"){const f=Zn(o.map(_=>_.clone().setZ(-.004)),2815999,i.key==="deck"?.1:.18,i.key==="contact"?.018:.026),p=Zn(o,7334143,i.key==="deck"?.72:.92,i.key==="contact"?.006:.008),x=Rt(o.map(_=>_.clone().multiplyScalar(1.04)),7334143,i.key==="deck"?.42:.72);x.position.z=.03,a.add(f,p,x)}const u=i.key==="value"||i.key==="mission"?fs(Math.min(s,r)*.32,96):i.key==="contact"?xl(s*.76,r*.74):i.key==="deck"?[new M(-s*.43,r*.08,0),new M(s*.43,r*.08,0)]:ki(s*.9,r*.74),d=Rt(u,2815999,.46);if(d.position.z=.014,a.add(d),i.key==="mission"&&(gl(a,s*.34,24,s*.02,7334143,.52),a.add(Rt(fs(s*.17,72).map(f=>f.add(new M(-s*.32,r*.08,.02))),7334143,.72),Rt(hr(s*.43,-.35,1.08,36),2815999,.88),Rt(hr(s*.39,2.06,3.84,42),16736122,.42),vn(-s*.32,r*.08,s*.035,2815999,.9),vn(-s*.4,r*.2,s*.026,16736122,.7),vn(-s*.24,-r*.05,s*.026,2815999,.7))),i.key==="deck"){for(let f=0;f<5;f+=1){const p=-s*.38+f*s*.19;a.add(Lt(p,-r*.18,s*.018,r*.24,f===4?16736122:2815999,.58),Rt(ki(s*.12,r*.19).map(x=>x.add(new M(p,-r*.18,.02))),f===4?16736122:2815999,.42),vn(p,r*.14,s*.02,2815999,.72))}a.add(Zn([new M(-s*.42,r*.14,.03),new M(s*.42,r*.14,.03)],2815999,.58,.007))}if(i.key==="value"&&(gl(a,s*.43,48,s*.026,7334143,.46),a.add(Rt(fs(s*.21,72),2815999,.44),Rt(hr(s*.38,-.1,.94,38),2815999,.9),Rt(hr(s*.31,1.45,2.4,32),16736122,.46),Rt([new M(-s*.43,0,.02),new M(s*.43,0,.02)],7334143,.38),Rt([new M(0,-r*.43,.02),new M(0,r*.43,.02)],7334143,.38))),i.key==="members"){for(let f=0;f<5;f+=1){const p=-s*.34+f*s*.17,x=Rt(fs(s*.038,36).map(m=>m.add(new M(p,r*.14,.028))),7334143,.74),_=Rt(Eg(s*.13,r*.38).map(m=>m.add(new M(p,-r*.1,.028))),2815999,.58);a.add(x,_,vn(p,r*.14,s*.018,2815999,.78),Lt(p,-r*.31,s*.1,r*.018,16736122,f%2?.36:.22))}a.add(Zn([new M(-s*.44,-r*.34,.02),new M(s*.44,-r*.34,.02)],2815999,.42,.006))}if(i.key==="contact"&&a.add(Lt(0,r*.4,s*.34,r*.024,2815999,.72),Lt(0,-r*.4,s*.28,r*.024,16736122,.62),Rt(ki(s*.78,r*.68),7334143,.38),vn(s*.28,r*.24,s*.035,16736122,.72)),i.key==="track"){a.add(Lt(-s*.31,r*.42,s*.22,.056,2815999,.94),Lt(-s*.08,r*.42,s*.08,.044,7334143,.72),Lt(s*.2,r*.42,s*.24,.034,2815999,.62),Lt(s*.4,r*.38,s*.13,.064,16736122,.96),Lt(-s*.38,-r*.39,s*.2,.032,2815999,.72),Lt(s*.14,-r*.39,s*.38,.03,2815999,.56),Lt(s*.44,-r*.18,.048,r*.32,7334143,.72),Lt(-s*.45,r*.03,.034,r*.42,2815999,.54),vn(-s*.44,r*.35,.052,2815999,.9),vn(s*.44,-r*.34,.044,16736122,.94)),[[-s*.47,r*.18,-s*.39,r*.3],[s*.48,-r*.06,s*.36,-r*.29],[-s*.12,-r*.48,s*.04,-r*.36],[-s*.42,r*.28,-s*.22,r*.28],[s*.18,-r*.28,s*.38,-r*.28]].forEach(([p,x,_,m])=>{const h=Rt([new M(p,x,.018),new M(_,m,.018)],2815999,.46);a.add(h)});for(let p=0;p<12;p+=1){const x=-s*.34+p*s*.052,_=p%3===0?.62:.32,m=Lt(x,r*.31,s*.026,.018,p%4===0?16736122:2815999,_);m.userData.phase=p*.37,a.add(m)}}return a.position.copy(e),a.rotation.copy(t),a.userData={key:i.key,plane:i.plane??"vertical",basePosition:e,baseRotation:t,baseScale:1,focusPosition:e.clone().add(new M(0,.15,1.15)),focusScale:1.18},vt.add(a),uu.set(i.key,a),a}function wg(){const i=document.createElement("canvas");i.width=4096,i.height=2048;const e=i.getContext("2d");e.clearRect(0,0,i.width,i.height),e.textBaseline="top",e.shadowColor="rgba(42, 247, 255, 0.7)",e.shadowBlur=34,e.fillStyle="rgba(234, 251, 255, 0.94)";const t=(s,r,a,o,c)=>{let l=o;do{if(e.font=`900 ${l}px "Hiragino Sans", "Yu Gothic", sans-serif`,e.measureText(s).width<=c||l<=300)break;l-=10}while(l>0);e.fillText(s,r,a)};t("あらゆる研究シーズを、",220,570,550,3860),e.shadowBlur=10,e.fillText("、",220+e.measureText("あらゆる研究シーズを").width+10,570),e.shadowBlur=34,t("事業に変える。",220,1128,430,3560),e.shadowBlur=4,e.fillStyle="rgba(234, 251, 255, 0.62)",e.font='700 96px "Hiragino Sans", "Yu Gothic", sans-serif',e.fillText("DeepTech Startup Studio / team ARMADA",232,1690);const n=new gd(i);return n.colorSpace=Ut,n.needsUpdate=!0,n}const Fs=new mn,Rg=new gt(Mi(23.5,9.4),new Ht({map:wg(),transparent:!0,opacity:.82,blending:Ft,depthWrite:!1,side:bt}));Fs.add(Rg);Fs.position.set(-4.65,-1.16,-4.95);Fs.rotation.set(-Math.PI/2,0,-.02);Fs.renderOrder=20;vt.add(Fs);const bu=[{key:"mission",eyebrow:"ARMADA OVERVIEW",title:"ARMADA OVERVIEW",body:"Value / Business / Company Creation",position:[-.8,1.38,-4.45],rotation:[0,0,0],plane:"screen",scale:.0128},{key:"track",eyebrow:"PORTFOLIO",title:"TRACK RECORD",stats:[["Startups","20+"],["Funding","33B+"],["Grants","30B+"],["Team","25"]],position:[6.65,1.55,5.35],rotation:[0,0,0],plane:"screen",scale:.0118},{key:"members",eyebrow:"OPERATOR ROSTER",title:"MEMBERS",body:"Code Name / Bio / Photo / Skill",position:[5.75,1.25,-4.85],rotation:[0,0,0],plane:"screen",scale:.0097},{key:"contact",eyebrow:"MAIL NODE",title:"CONTACT",body:"相談 / 会社概要",position:[7.25,-.6,6.15],rotation:[-Math.PI/2,0,0],plane:"ground",scale:.0054}];bu.forEach(i=>{["mission","track","members","contact"].includes(i.key)||(Sg(i),Ag(i))});function dn(i,e,t=-1.2){return[ei.x+(i-.5)*ii.width,t,ei.z+(e-.5)*ii.height]}function Cg(i){return[(i.x-ei.x)/ii.width+.5,(i.z-ei.z)/ii.height+.5]}const Pg=[{id:"bwe",type:"startup",institution:"山口大学発",company:"Blue Water Energy",area:"宇部市 / RED塩分濃度差発電",monogram:"BWE",url:"https://www.bluewaterenergy.jp/",mapUv:[.195,.604],anchor:dn(.195,.604),card:[-12.2,2.28,5]},{id:"jc",type:"startup",institution:"群馬大学発",company:"JOYCLE",area:"東京都港区 / 廃棄物熱分解",monogram:"JC",url:"https://joycle.net/",mapUv:[.635,.585],anchor:dn(.635,.585),card:[6.8,2.34,9.7]},{id:"ctb",type:"startup",institution:"筑波大学発",company:"CrestecBio",area:"つくば / 創薬",monogram:"CTB",url:"https://crestecbio.com/",mapUv:[.645,.552],anchor:dn(.645,.552),card:[13.6,2.66,.8]},{id:"tiem",type:"startup",institution:"京都大学発",company:"tiemfactory",area:"茨城町 / 素材・断熱",monogram:"TiEM",url:"https://www.tiem.jp/",mapUv:[.66,.55],anchor:dn(.66,.55),card:[12.6,2.05,3.7],scale:.0104},{id:"yd",type:"startup",institution:"Deeptech化中",company:"Yellow Duck",area:"神戸市 / 波力発電",monogram:"YD",url:"https://yellow-duck.jp/",mapUv:[.43,.61],anchor:dn(.43,.61),card:[-.9,1.96,11.45],scale:.0104},{id:"lst",type:"startup",institution:"QST発",company:"LiSTie",area:"六ヶ所村 / リチウム資源",monogram:"LST",url:"https://www.listie.co.jp/",mapUv:[.705,.273],anchor:dn(.705,.273),card:[5.5,3.02,-8.35]},{id:"nims",type:"research",institution:"RESEARCH PARTNER",company:"物質・材料研究機構",area:"National Institute for Materials Science",monogram:"NIMS",url:"https://www.nims.go.jp/",mapUv:[.648,.552],anchor:dn(.648,.552),card:[8.8,2,-1.55],scale:.0102},{id:"ehime",type:"research",institution:"RESEARCH PARTNER",company:"愛媛大学",area:"Ehime University",monogram:"愛媛",url:"https://www.ehime-u.ac.jp/",mapUv:[.29,.625],anchor:dn(.29,.625),card:[-9.6,1.95,8.45],scale:.0102},{id:"kogakuin",type:"research",institution:"RESEARCH PARTNER",company:"工学院大学",area:"Kogakuin University",monogram:"工学院",url:"https://www.kogakuin.ac.jp/",mapUv:[.605,.59],anchor:dn(.605,.59),card:[9.3,1.95,6.15],scale:.0102},{id:"isct",type:"research",status:"ended",institution:"RESEARCH PARTNER",company:"東京科学大学",area:"Institute of Science Tokyo",monogram:"SCI",url:"https://www.isct.ac.jp/",mapUv:[.632,.59],anchor:dn(.632,.59),card:[2.7,1.9,7.65],scale:.0101},{id:"kagawa",type:"research",status:"upcoming",institution:"RESEARCH PARTNER",company:"香川大学",area:"Kagawa University",monogram:"香川",url:"https://www.kagawa-u.ac.jp/",mapUv:[.344,.608],anchor:dn(.344,.608),card:[-6,1.92,11.15],scale:.0101}],Ps={width:5.08,height:1.58},_l={startup:{width:640,height:196},research:{width:600,height:182}};function Dg(i,e){const t=i.type==="research"?_l.research:_l.startup;return{width:t.width*e,height:t.height*e}}function xs(i,e,t=Ps.width,n=Ps.height){const s={left:new M(-t/2,0,0),right:new M(t/2,0,0),top:new M(0,0,-n/2),bottom:new M(0,0,n/2)};return i.clone().add(s[e]??s.left)}const Ji={bwe:"bottom"};function Lg(i){return i.type==="research"?{primary:16762975,secondary:16770470,accent:16752957,fill:3351051,opacity:.78}:{primary:16736155,secondary:16754374,accent:16765406,fill:3478050,opacity:.84}}function Ug(i){const e=document.createElement("a");return e.className=`track-site-card is-${i.type??"startup"}${i.status?` is-${i.status}`:""}`,e.href=i.url??"#",e.target="_blank",e.rel="noopener noreferrer",e.setAttribute("aria-label",`${i.company}の詳細を開く`),e.innerHTML=`
    <span class="track-copy">
      <span class="track-institution">${i.institution}</span>
      <strong>${i.company}</strong>
      <span>${i.area}</span>
    </span>
  `,e.addEventListener("click",t=>{t.stopPropagation(),ts&&t.preventDefault()}),e}function Ig(i,e,t=Ps.width,n=Ps.height){const s=[xs(e,"left",t,n),xs(e,"right",t,n),xs(e,"top",t,n),xs(e,"bottom",t,n)];return s.reduce((r,a)=>a.distanceTo(i)<r.distanceTo(i)?a:r,s[0])}function Su(i,e,t,n=Ps){const s=Ji[t]?xs(e,Ji[t],n.width,n.height):Ig(i,e,n.width,n.height);return[i,s]}const Ng=[{key:"mission",title:"眠る知財をビジネスに変え、日本をディープテックの渦にする。",kicker:"MISSION / OUR DNA / CEO MESSAGE",body:"大学・研究機関には、社会を変えうる研究シーズが眠っている。ARMADAは会社になる前の空白に入り、技術の可能性を見極め、DeepTech Startupとして社会実装する道筋をつくる。山地正洋",points:["Before 0の空白へ入る","研究者の意思決定を支える","研究を事業に、事業を国の力に"],position:[-.25,1.55,5.75],rotation:[0,0,0],scale:.0122,frame:[6.05,2.35]},{key:"deck",title:"Before 0から一気通貫で実行する。",kicker:"BUSINESS / COMMAND DECK",body:"研究シーズの発掘、事業化テーマ選定、役割設計、法人設立、資金調達・助成金・広報、PoC、組織づくり、自走体制への移行までを扱う。",points:["Seed Discovery","Before 0 Design","Company Launch","0 to 1 Execution","Graduation"],position:[-.25,1.55,5.75],rotation:[0,0,0],scale:.0122,frame:[6.05,2.35]},{key:"value",title:"Before Zero Theory と ARMADA Protocol",kicker:"VALUE ENGINE / THEORY + PROTOCOL",body:"会社になる前の空白を扱うBefore Zero Theoryと、判断・実行・学習を構造化するARMADA Protocolを束ね、DeepTech Startup創出を再現可能な事業化システムへ変える。",points:["Before Zero Theory","ARMADA Protocol","ARMADA OS","What / Why / How / Result"],position:[-.25,1.55,5.75],rotation:[0,0,0],scale:.0122,frame:[6.05,2.35]},{key:"track",title:"大学・研究機関の技術を、DeepTech Startupへ。",kicker:"TRACK RECORD / PORTFOLIO",body:"20 PJ超の創出・経営関与、累計資金調達33億円超、助成金獲得30億円超。公開可能な連携実績は、地図上のビーコンとして各地域に展開する。",points:["JOYCLE","LiSTie","Blue Water Energy","CrestecBio","ティエムファクトリ"],position:[-.25,1.55,5.75],rotation:[0,0,0],scale:.0122,frame:[6.05,2.35]},{key:"members",title:"技術と事業をつなぎ、創業前から経営に入る実行チーム。",kicker:"MEMBERS / OPERATOR ROSTER",body:"山地正洋、肥塚恭子、輕部琢真、藤崎百合恵、深山蘭、宮崎航一、安孫子芽生、中井遥、梅本隆司、夏目奏。研究・戦略・PM・公的資金・組織づくり・広報をひとつの実行チームとして束ねる。",points:["Founder / Studio Lead","Strategy / MOT","PM / Execution","IP / Public Funding / Corporate","Communication / Design"],position:[-.25,1.55,5.75],rotation:[0,0,0],scale:.0118,frame:[6.25,2.55]},{key:"contact",title:"事業化について相談する。",kicker:"CONTACT / COMPANY PROFILE",body:"株式会社チームアルマダ。DeepTech Startupの創出・経営、研究機関発技術の事業化を担う。大学・研究機関、研究者、VC、事業会社、行政の方が相談を始める入口。",points:["大学・研究機関","研究者・PI","VC・金融機関","事業会社・行政"],position:[-.25,1.55,5.75],rotation:[0,0,0],scale:.0122,frame:[6.05,2.35]}];function Fg(i){const e=document.createElement("article");return e.className=`focus-detail-card focus-detail-${i.key}`,e.innerHTML=`
    <span class="focus-detail-kicker">${i.kicker}</span>
    <strong>${i.title}</strong>
    <span class="focus-detail-body">${i.body}</span>
  `,e}function Og(i,e){const t=new mn,n=ki(i,e),s=new gt(Mi(i*.94,e*.84),new Ht({color:204595,transparent:!0,opacity:.32,blending:Ft,depthWrite:!1,side:bt}));return s.userData.baseOpacity=s.material.opacity,t.add(s,Zn(n.map(r=>r.clone().setZ(-.004)),2815999,.17,.024),Zn(n,7334143,.82,.007),Rt(ki(i*.88,e*.7),2815999,.36),Lt(-i*.32,e*.36,i*.22,.028,2815999,.62),Lt(i*.32,e*.33,i*.16,.038,16736122,.72),Lt(-i*.36,-e*.36,i*.24,.018,2815999,.42)),t}Ng.forEach(i=>{const e=new Fo(Fg(i));e.position.set(...i.position),e.rotation.set(...i.rotation),e.scale.setScalar(i.scale),e.userData.key=i.key,e.element.style.opacity="0",e.element.style.pointerEvents="none",Zi.add(e),hu.push(e);const t=Og(...i.frame);t.position.copy(e.position),t.rotation.copy(e.rotation),t.userData.key=i.key,t.visible=!1,vt.add(t),du.push(t)});function Bg(i,e){const t=new mn;return t.userData.width=i,t.userData.height=e,t}Pg.forEach(i=>{const e=new Fo(Ug(i));e.position.set(...i.card),e.rotation.set(0,0,0),e.scale.setScalar((i.scale??.0124)*1.22);const t=Dg(i,e.scale.x);e.userData.basePosition=e.position.clone(),e.userData.phase=ji.length*.5,e.element.style.opacity="0",e.element.style.pointerEvents="none",Zi.add(e),ji.push(e);const n=Lg(i),s=Bg(t.width,t.height);s.position.copy(e.position),s.rotation.copy(e.rotation),s.userData.phase=e.userData.phase,s.visible=!1,s.children.forEach(d=>{d.material&&(d.material.opacity=0)}),vt.add(s),Cs.push(s);const r=new M(...i.anchor),a=new M(...i.card),o=Su(r,a,i.id,t),c=pl(o,n.primary,n.opacity,.016);c.renderOrder=10,c.visible=!1,vt.add(c),bs.push(c);const l=pl(o,n.secondary,.22,.044);l.renderOrder=9,l.visible=!1,vt.add(l),bs.push(l);const u=new gt(hg(.065,14,14),new Ht({color:n.accent,transparent:!0,opacity:.8,blending:Ft,depthWrite:!1}));u.position.copy(r),u.userData.baseOpacity=.8,u.userData.phase=e.userData.phase,u.material.opacity=0,u.visible=!1,vt.add(u),bs.push(u),An.push({site:i,object:e,frameSize:t,theme:n,line:c,lineHalo:l,pin:u})});function Bo(i){const e=new M(...i.site.anchor),t=new M(...i.site.card),n=Su(e,t,i.site.id,i.frameSize);ml(i.line,n,i.theme.primary,i.theme.opacity,.016),ml(i.lineHalo,n,i.theme.secondary,.22,.044),i.pin.position.copy(e)}const we={active:ts,selectedId:null,draggingId:null,dragMode:null,dragOffset:new M,markers:new Map,cardMarkers:new Map};function Ar(i,e,t=-1.2){dl.set(i/window.innerWidth*2-1,-(e/window.innerHeight)*2+1),hl.setFromCamera(dl,dt),fl.constant=-t;const n=new M;return hl.ray.intersectPlane(fl,n)?n:null}function di(i){we.selectedId=i;const e=An.find(t=>t.site.id===i);sl&&(sl.textContent=e?`${e.site.id.toUpperCase()} / ${e.site.company}`:"SELECT ANCHOR"),we.markers.forEach((t,n)=>{t.classList.toggle("is-selected",n===i)}),we.cardMarkers.forEach((t,n)=>{t.classList.toggle("is-selected",n===i)}),An.forEach(({site:t,object:n})=>{n.element.classList.toggle("is-edit-selected",t.id===i)}),au.forEach(t=>{const n=Ji[i]??"auto";t.classList.toggle("is-active",t.dataset.trackEdge===n)})}function wr(i){const e=we.markers.get(i.site.id);if(e){const n=new M(...i.site.anchor).project(dt);e.style.transform=`translate3d(${(n.x+1)/2*window.innerWidth}px, ${(-n.y+1)/2*window.innerHeight}px, 0)`,e.classList.toggle("is-hidden",st!=="track"||n.z<-1||n.z>1)}const t=we.cardMarkers.get(i.site.id);if(t){const n=new M(...i.site.card).project(dt);t.style.transform=`translate3d(${(n.x+1)/2*window.innerWidth}px, ${(-n.y+1)/2*window.innerHeight}px, 0)`,t.classList.toggle("is-hidden",st!=="track"||n.z<-1||n.z>1)}}function kg(){we.active&&An.forEach(wr)}function ba(i,e,t){const n=An.find(r=>r.site.id===i),s=Ar(e,t,n?.site.anchor[1]??-1.2);!n||!s||(s.y=n.site.anchor[1]??-1.2,n.site.anchor=[s.x,s.y,s.z],n.site.mapUv=Cg(s),Bo(n),wr(n))}function dr(i,e,t){const n=An.find(o=>o.site.id===i);if(!n)return;const s=n.site.card[1],r=Ar(e,t,s);if(!r)return;r.add(we.dragOffset),r.y=s,n.site.card=[r.x,r.y,r.z],n.object.position.copy(r),n.object.userData.basePosition.copy(r);const a=Cs[ji.indexOf(n.object)];a&&a.position.copy(r),Bo(n)}function zg(){return An.map(({site:i})=>({id:i.id,company:i.company,mapUv:i.mapUv.map(e=>Number(e.toFixed(4))),anchor:i.anchor.map(e=>Number(e.toFixed(3))),card:i.card.map(e=>Number(e.toFixed(3))),edge:Ji[i.id]??"auto"}))}async function Vg(){const i=JSON.stringify(zg(),null,2);try{await navigator.clipboard.writeText(i),ms&&(ms.textContent="COPIED")}catch{window.prompt("Track edit JSON",i)}window.setTimeout(()=>{ms&&(ms.textContent="COPY JSON")},1400)}function Hg(){ts&&(An.forEach(i=>{i.object.element.classList.add("is-edit-draggable"),i.object.element.addEventListener("pointerdown",n=>{n.preventDefault(),n.stopPropagation(),i.object.element.setPointerCapture(n.pointerId),we.draggingId=i.site.id,we.dragMode="card",di(i.site.id);const s=Ar(n.clientX,n.clientY,i.site.card[1]),r=new M(...i.site.card);we.dragOffset.copy(s?r.sub(s):new M)}),i.object.element.addEventListener("pointermove",n=>{we.draggingId!==i.site.id||we.dragMode!=="card"||(n.preventDefault(),dr(i.site.id,n.clientX,n.clientY))}),i.object.element.addEventListener("pointerup",n=>{we.draggingId===i.site.id&&we.dragMode==="card"&&(dr(i.site.id,n.clientX,n.clientY),we.draggingId=null,we.dragMode=null,we.dragOffset.set(0,0,0))}),i.object.element.addEventListener("pointercancel",()=>{we.draggingId===i.site.id&&(we.draggingId=null,we.dragMode=null,we.dragOffset.set(0,0,0))});const e=document.createElement("button");e.type="button",e.className=`track-anchor-handle is-${i.site.type??"startup"}`,e.textContent=i.site.id.toUpperCase(),e.setAttribute("aria-label",`${i.site.company}の地図側接点を編集`),e.addEventListener("pointerdown",n=>{n.preventDefault(),n.stopPropagation(),e.setPointerCapture(n.pointerId),we.draggingId=i.site.id,we.dragMode="anchor",di(i.site.id),ba(i.site.id,n.clientX,n.clientY)}),e.addEventListener("pointermove",n=>{we.draggingId!==i.site.id||we.dragMode!=="anchor"||(n.preventDefault(),ba(i.site.id,n.clientX,n.clientY))}),e.addEventListener("pointerup",n=>{we.draggingId===i.site.id&&we.dragMode==="anchor"&&(ba(i.site.id,n.clientX,n.clientY),we.draggingId=null,we.dragMode=null)}),e.addEventListener("pointercancel",()=>{we.draggingId===i.site.id&&(we.draggingId=null,we.dragMode=null)}),e.addEventListener("click",n=>{n.preventDefault(),n.stopPropagation(),di(i.site.id)}),fo.appendChild(e),we.markers.set(i.site.id,e);const t=document.createElement("button");t.type="button",t.className=`track-card-handle is-${i.site.type??"startup"}`,t.textContent=`CARD ${i.site.id.toUpperCase()}`,t.setAttribute("aria-label",`${i.site.company}のカード位置を編集`),t.addEventListener("pointerdown",n=>{n.preventDefault(),n.stopPropagation(),t.setPointerCapture(n.pointerId),we.draggingId=i.site.id,we.dragMode="card",di(i.site.id);const s=Ar(n.clientX,n.clientY,i.site.card[1]),r=new M(...i.site.card);we.dragOffset.copy(s?r.sub(s):new M)}),t.addEventListener("pointermove",n=>{we.draggingId!==i.site.id||we.dragMode!=="card"||(n.preventDefault(),dr(i.site.id,n.clientX,n.clientY),wr(i))}),t.addEventListener("pointerup",n=>{we.draggingId===i.site.id&&we.dragMode==="card"&&(dr(i.site.id,n.clientX,n.clientY),wr(i),we.draggingId=null,we.dragMode=null,we.dragOffset.set(0,0,0))}),t.addEventListener("pointercancel",()=>{we.draggingId===i.site.id&&(we.draggingId=null,we.dragMode=null,we.dragOffset.set(0,0,0))}),t.addEventListener("click",n=>{n.preventDefault(),n.stopPropagation(),di(i.site.id)}),fo.appendChild(t),we.cardMarkers.set(i.site.id,t)}),au.forEach(i=>{i.addEventListener("click",e=>{e.stopPropagation();const t=we.selectedId;if(!t)return;const n=i.dataset.trackEdge;n==="auto"?delete Ji[t]:Ji[t]=n;const s=An.find(r=>r.site.id===t);s&&Bo(s),di(t)})}),ms?.addEventListener("click",i=>{i.stopPropagation(),Vg()}),di(An[0]?.site.id??null))}Hg();const Os=new jl(34,68,2815999,749506);Os.material.transparent=!0;Os.material.opacity=.38;Os.position.y=-1.55;Os.visible=!1;vt.add(Os);const ss=new jl(22,22,16736122,1740774);ss.material.transparent=!0;ss.material.opacity=.08;ss.rotation.y=Math.PI/4;ss.position.y=-1.52;ss.visible=!1;vt.add(ss);const yu=new Bd;function Gg(){const i=new At;return i.colorSpace=Ut,i.anisotropy=Cn.capabilities.getMaxAnisotropy(),i}function Wg(i){const e=Gg(),t=n=>{const s=i[n];s&&yu.load(ht(s),r=>{e.image=r.image,e.colorSpace=Ut,e.anisotropy=Cn.capabilities.getMaxAnisotropy(),e.needsUpdate=!0,r.dispose()},void 0,()=>t(n+1))};return t(0),e}const Eu=Wg(["/assets/japan_hud_map_texture_alpha_v1_hd.avif","/assets/japan_hud_map_texture_alpha_v1_hd.webp","/assets/japan_hud_map_texture_alpha_v1_hd.png"]),ko=yu.load(ht("/assets/hud_ring_layer_v1.png"));ko.colorSpace=Ut;ko.anisotropy=Cn.capabilities.getMaxAnisotropy();const Ur=new gt(Mi(ii.width,ii.height,1,1),new Ht({map:Eu,color:16777215,transparent:!0,opacity:.98,blending:Ft,depthWrite:!1,side:bt}));Ur.rotation.x=-Math.PI/2;Ur.position.copy(ei);Ur.renderOrder=2;vt.add(Ur);const Bs=new gt(Mi(ii.width*1.025,ii.height*1.025,1,1),new Ht({map:Eu,color:2815999,transparent:!0,opacity:.3,blending:Ft,depthWrite:!1,side:bt}));Bs.rotation.x=-Math.PI/2;Bs.position.set(ei.x,ei.y+.03,ei.z);Bs.renderOrder=3;vt.add(Bs);function fr({size:i,x:e=3.15,y:t,z:n,opacity:s,rotationZ:r,color:a,spin:o,renderOrder:c}){const l=new gt(Mi(i,i),new Ht({map:ko,color:a,transparent:!0,opacity:s,blending:Ft,depthWrite:!1,side:bt}));return l.rotation.set(-Math.PI/2,0,r),l.position.set(e,t,n),l.userData.spin=o,l.renderOrder=c,vt.add(l),l}const Xg=[fr({size:37.6,x:3.05,y:-4.95,z:.45,opacity:.13,rotationZ:.28,color:5829631,spin:.011,renderOrder:1}),fr({size:45.2,x:3.05,y:-4.35,z:.45,opacity:.11,rotationZ:-.42,color:2815999,spin:-.008,renderOrder:1}),fr({size:53.6,x:3.05,y:-3.75,z:.45,opacity:.1,rotationZ:.08,color:8255487,spin:.006,renderOrder:1}),fr({size:60,x:3.05,y:-3.15,z:.45,opacity:.075,rotationZ:-.18,color:2815999,spin:-.004,renderOrder:1})];function Sa({radius:i,centerX:e=3.15,y:t,z:n,start:s,end:r,color:a,opacity:o,tube:c,phase:l}){const u=[];for(let p=0;p<=96;p+=1){const x=s+(r-s)*(p/96);u.push(new M(e+Math.cos(x)*i,t,n+Math.sin(x)*i))}const f=new gt(mu(u,96,c),new Ht({color:a,transparent:!0,opacity:o,blending:Ft,depthWrite:!1}));return f.userData.baseOpacity=o,f.userData.phase=l,f.renderOrder=8,vt.add(f),f}const Tu=[Sa({radius:9.8,centerX:3.05,y:-2.75,z:.45,start:Math.PI*.08,end:Math.PI*.92,color:5829631,opacity:.18,tube:.018,phase:.1}),Sa({radius:12.4,centerX:3.05,y:-1.05,z:.45,start:Math.PI*.1,end:Math.PI*.84,color:2815999,opacity:.12,tube:.026,phase:1.4}),Sa({radius:15,centerX:3.05,y:-.62,z:.45,start:Math.PI*.16,end:Math.PI*.76,color:8255487,opacity:.075,tube:.034,phase:2.2})];Tu.forEach(i=>{i.visible=!1});const Ir=Zn([new M(-2.4,-1.16,2.8),new M(.7,-1.12,2),new M(3.15,-1.06,1.2),new M(5.4,-1,.12),new M(7.25,-.92,-.7)],2815999,.38,.018);Ir.userData.baseOpacity=.38;Ir.renderOrder=9;vt.add(Ir);const Yg=[[-2.4,-1.14,2.8],[.7,-1.1,2],[3.15,-1.04,1.2],[5.4,-.98,.12],[7.25,-.9,-.7]].map((i,e)=>{const t=vn(0,0,.095,e===4?16736122:2815999,e===4?.9:.72);return t.position.set(...i),t.rotation.x=-Math.PI/2,t.renderOrder=10,vt.add(t),t}),Jn=Zn([new M(-2.55,-.78,-2.72),new M(.2,-.92,-1.9),new M(3.1,-.94,-1.1),new M(5.6,-.88,-.15),new M(4.45,-.78,3.1),new M(2.05,-.68,4.6)],7334143,.32,.011);Jn.userData.baseOpacity=.32;Jn.renderOrder=11;vt.add(Jn);const Au=[{label:"01",position:[-2.55,-.74,-2.72],color:16736122},{label:"02",position:[5.6,-.84,-.15],color:2815999},{label:"03",position:[4.45,-.74,3.1],color:2815999},{label:"04",position:[2.05,-.64,4.6],color:16736122}].map((i,e)=>{const t=vn(0,0,e===0?.12:.09,i.color,e===0?.96:.74);return t.position.set(...i.position),t.rotation.x=-Math.PI/2,t.userData.baseOpacity=e===0?.96:.74,t.userData.phase=e*.85,t.renderOrder=12,vt.add(t),t});Ir.visible=!1;Yg.forEach(i=>{i.visible=!1});Jn.visible=!1;Au.forEach(i=>{i.visible=!1});window.addEventListener("pointermove",i=>{ul.x=(i.clientX/window.innerWidth-.5)*2,ul.y=(i.clientY/window.innerHeight-.5)*2});function qg(i){}function $g(i){const e=i.clientX-sn.x,t=i.clientY-sn.y;if(sn.moved=sn.moved||Math.hypot(e,t)>12,!po&&sn.hitKey){if(Math.hypot(e,t)<16)return;sn.hitKey=null;return}if(!po)return;const n=Math.max(-.95,Math.min(.95,sn.ry+e*.0045)),s=Math.max(-.38,Math.min(.38,sn.rx+t*.0032));Sn.y=n,Sn.x=s}function wu(){if(sn.hitKey){Ki=Date.now()+260,an(sn.hitKey),sn.hitKey=null;return}!sn.moved&&st!=="home"&&an("home"),po=!1,document.body.classList.remove("is-dragging-deck")}on.domElement.addEventListener("pointerdown",qg);on.domElement.addEventListener("pointermove",$g);on.domElement.addEventListener("pointerup",wu);on.domElement.addEventListener("pointercancel",wu);function Kg(){dt.aspect=window.innerWidth/window.innerHeight,dt.updateProjectionMatrix(),Cn.setPixelRatio(Math.min(window.devicePixelRatio,1.7)),Cn.setSize(window.innerWidth,window.innerHeight),_i.setPixelRatio(Math.min(window.devicePixelRatio,1.7)),_i.setSize(window.innerWidth,window.innerHeight),on.setSize(window.innerWidth,window.innerHeight),on.domElement.firstElementChild.style.pointerEvents="auto"}window.addEventListener("resize",Kg);let Ru=!0,Dt=0,mo=!1;document.addEventListener("visibilitychange",()=>{Ru=!document.hidden});function jg(){mo=!1,ji.forEach((i,e)=>{i.element.style.opacity="0",i.element.style.pointerEvents="none";const t=Cs[e];t&&(t.visible=!1,t.children.forEach(n=>{n.material&&(n.material.opacity=0)}))}),bs.forEach(i=>{i.visible=!1,i.material?i.material.opacity=0:i.children?.forEach(e=>{e.material&&(e.material.opacity=0)}),i.geometry?.type==="SphereGeometry"&&i.scale.setScalar(1)})}function Cu(){if(requestAnimationFrame(Cu),!Ru)return;Math.min(ll.getDelta(),.05);const i=ll.elapsedTime,e=ru?.12:1;if(Sn.x=0,Sn.y=0,Bs.material.opacity=.13+Math.sin(i*1.2)*.035,Xg.forEach(s=>{s.rotation.z+=s.userData.spin*.048*e}),Tu.forEach(s=>{s.material.opacity=s.userData.baseOpacity+Math.sin(i*1.05+s.userData.phase)*s.userData.baseOpacity*.18}),Jn?.visible&&Jn?.material){const s=.72+Math.sin(i*1.65)*.28;Jn.material.opacity=Jn.userData.baseOpacity*s}Au.forEach(s=>{if(!s.visible||!s.material)return;const r=s.userData.baseOpacity??s.material.opacity;s.material.opacity=r*(.76+Math.sin(i*2.1+s.userData.phase)*.24)}),lu.forEach((s,r)=>{const a=st===r,o=st!=="home"&&!a,c=a&&st!=="home"&&s.userData.plane==="ground",l=a&&st!=="home"&&!c?rl:s.userData.basePosition,u=a&&st!=="home"&&!c?s.userData.baseScale*.88:s.userData.baseScale;s.position.lerp(l,.034*e);const d=a&&st!=="home"&&!c?new qt(-nn.x,-nn.y,al.z):s.userData.baseRotation;s.rotation.x+=(d.x-s.rotation.x)*.038*e,s.rotation.y+=(d.y-s.rotation.y)*.038*e,s.rotation.z+=(d.z-s.rotation.z)*.038*e;const f=s.scale.x;s.scale.setScalar(f+(u-f)*.034*e),s.element.classList.toggle("is-active",a),s.element.classList.toggle("is-muted",o),s.element.classList.toggle("is-docked",a&&st!=="home"&&!c)}),uu.forEach((s,r)=>{const a=st===r,o=st!=="home"&&!a,c=st==="track"&&r!=="track",l=a&&st!=="home"&&s.userData.plane==="ground",u=a&&st!=="home"&&!l?rl:s.userData.basePosition,d=a&&st!=="home"&&!l?.88:s.userData.baseScale;s.position.lerp(u,.034*e);const f=a&&st!=="home"&&!l?new qt(-nn.x,-nn.y,al.z):s.userData.baseRotation;s.rotation.x+=(f.x-s.rotation.x)*.038*e,s.rotation.y+=(f.y-s.rotation.y)*.038*e,s.rotation.z+=(f.z-s.rotation.z)*.038*e;const p=s.scale.x;s.scale.setScalar(p+(d-p)*.034*e),s.children.forEach(x=>{if(x.material){const _=x.userData.baseOpacity??x.material.opacity,m=x.userData.kind==="rail"?1+Math.sin(i*1.8+(s.userData.phase??0))*.12:1,w=o||c||a&&st!=="home"&&!l?0:.58;x.material.opacity+=(w*_*m-x.material.opacity)*.08*e}})}),hu.forEach((s,r)=>{const a=st===s.userData.key?1:0;s.element.style.opacity="0",s.element.style.pointerEvents="none",s.element.classList.toggle("is-modal-open",a>.05);const o=du[r];o.visible=!1,o.children.forEach(c=>{c.material&&(c.material.opacity=0)})});const t=st==="track"?1:0;if(t>0||Dt>.015){const s=Dt;Dt+=(t-Dt)*.08*e;const r=Math.abs(Dt-t)<.01,a=!mo||!r||Math.abs(Dt-s)>.003;ji.forEach((o,c)=>{o.position.copy(o.userData.basePosition),a&&(o.element.style.opacity=`${Dt}`),o.element.style.pointerEvents=Dt>.5?"auto":"none";const l=Cs[c];l&&(l.visible=Dt>.02,l.position.copy(o.position),l.rotation.copy(o.rotation),a&&l.children.forEach(u=>{if(!u.material)return;const d=u.userData.baseOpacity??u.material.opacity;u.material.opacity+=(d*Dt-u.material.opacity)*.18*e}))}),bs.forEach(o=>{o.visible=Dt>.02;const c=o.userData.baseOpacity??.56;a&&(o.material?o.material.opacity+=(c*Dt-o.material.opacity)*.16*e:o.children?.forEach(l=>{if(!l.material)return;const u=l.userData.baseOpacity??c;l.material.opacity+=(u*Dt-l.material.opacity)*.16*e}))}),mo=r}else Dt!==0&&(Dt=0,jg());if(nn.x+=(Sn.x-nn.x)*.08*e,nn.y+=(Sn.y-nn.y)*.08*e,vt.rotation.x=nn.x,vt.rotation.y=nn.y,Zi.rotation.x=nn.x,Zi.rotation.y=nn.y,mt.active){const s=Math.min(1,(performance.now()-mt.startTime)/mt.duration),r=1-Math.pow(1-s,2.2);dt.position.copy(mt.startPosition).lerp(mt.position,r),Nt.target.copy(mt.startLookAt).lerp(mt.lookAt,r),dt.fov=Dl.lerp(mt.startZoom,mt.zoom,r),dt.updateProjectionMatrix(),s>=1&&(dt.position.copy(mt.position),Nt.target.copy(mt.lookAt),dt.fov=mt.zoom,dt.updateProjectionMatrix(),mt.active=!1)}Nt.update(),Dt>.02&&ji.forEach((s,r)=>{s.quaternion.copy(dt.quaternion),Cs[r]?.quaternion.copy(dt.quaternion)}),kg(),_i.render(),on.render(gu,dt)}Cu();
