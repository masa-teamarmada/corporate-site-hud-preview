...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:yn,depthTest:!1,depthWrite:!1})}function Xp(i,e,t){const n=new Float32Array(ci),s=new M(0,1,0);return new Nt({name:"SphericalGaussianBlur",defines:{n:ci,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:mr(),fragmentShader:`
		...
		`,blending:yn,depthTest:!1,depthWrite:!1})}function _l(){return new Nt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:mr(),fragmentShader:`
		...
		`,blending:yn,depthTest:!1,depthWrite:!1})}function vl(){return new Nt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:mr(),fragmentShader:`
	...
	`}function Yp(i){let e=new WeakMap,t=null;function n(o){if(o&&o.isTexture){const l=o.mapping,c=l===Ma||l===ba,h=l===Bi||l===zi;if(c||h){let d=e.get(o);const f=d!==void 0?d.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==f)return t===null&&(t=new xl(i)),d=c?t.fromEquirectangular(o,d):t.fromCubemap(o,d),d.texture.pmremVersion=o.pmremVersion,e.set(o,d),d.texture;if(d!==void 0)return d.texture;{const p=o.image;return c&&p&&p.height>0||h&&p&&s(p)?(t===null&&(t=new xl(i)),d=c?t.fromEquirectangular(o):t.fromCubemap(o),d.texture.pmremVersion=o.pmremVersion,e.set(o,d),o.addEventListener("dispose",r),d.texture):null}}}return o}function s(o){let l=0;const c=6;for(let h=0;h<c;h++)o[h]!==void 0&&l++;return l===c}function r(o){const l=o.target;l.removeEventListener("dispose",r);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function a(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:a}}function qp(i){const e={};function t(n){if(e[n]!==void 0)return e[n];const s=i.getExtension(n);return e[n]=s,s}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const s=t(n);return s===null&&ds("WebGLRenderer: "+n+" extension not supported."),s}}}function $p(i,e,t,n){const s={},r=new WeakMap;function a(d){const f=d.target;f.index!==null&&e.remove(f.index);for(const x in f.attributes)e.remove(f.attributes[x]);f.removeEventListener("dispose",a),delete s[f.id];const p=r.get(f);p&&(e.remove(p),r.delete(f)),n.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,t.memory.geometries--}function o(d,f){return s[f.id]===!0||(f.addEventListener("dispose",a),s[f.id]=!0,t.memory.geometries++),f}function l(d){const f=d.attributes;for(const p in f)e.update(f[p],i.ARRAY_BUFFER)}function c(d){const f=[],p=d.index,x=d.attributes.position;let _=0;if(p!==null){const w=p.array;_=p.version;for(let E=0,A=w.length;E<A;E+=3){const R=w[E+0],y=w[E+1],D=w[E+2];f.push(R,y,y,D,D,R)}}else if(x!==void 0){const w=x.array;_=x.version;for(let E=0,A=w.length/3-1;E<A;E+=3){const R=E+0,y=E+1,D=E+2;f.push(R,y,y,D,D,R)}}else return;const m=new(ac(f)?hc:uc)(f,1);m.version=_;const u=r.get(d);u&&e.remove(u),r.set(d,m)}function h(d){const f=r.get(d);if(f){const p=d.index;p!==null&&f.version<p.version&&c(d)}else c(d);return r.get(d)}return{get:o,update:l,getWireframeAttribute:h}}function Kp(i,e,t){let n;function s(f){n=f}let r,a;function o(f){r=f.type,a=f.bytesPerElement}function l(f,p){i.drawElements(n,p,r,f*a),t.update(p,n,1)}function c(f,p,x){x!==0&&(i.drawElementsInstanced(n,p,r,f*a,x),t.update(p,n,x))}function h(f,p,x){if(x===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,p,0,r,f,0,x);let m=0;for(let u=0;u<x;u++)m+=p[u];t.update(m,n,1)}function d(f,p,x,_){if(x===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let u=0;u<f.length;u++)c(f[u]/a,p[u],_[u]);else{m.multiDrawElementsInstancedWEBGL(n,p,0,r,f,0,_,0,x);let u=0;for(let w=0;w<x;w++)u+=p[w]*_[w];t.update(u,n,1)}}this.setMode=s,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=h,this.renderMultiDrawInstances=d}function Zp(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(r/3);break;case i.LINES:t.lines+=o*(r/2);break;case i.LINE_STRIP:t.lines+=o*(r-1);break;case i.LINE_LOOP:t.lines+=o*r;break;case i.POINTS:t.points+=o*r;break;default:gt("WebGLInfo: Unknown draw mode:",a);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:n}}function Jp(i,e,t){const n=new WeakMap,s=new je;function r(a,o,l){const c=a.morphTargetInfluences,h=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,d=h!==void 0?h.length:0;let f=n.get(o);if(f===void 0||f.count!==d){let b=function(){N.dispose(),n.delete(o),o.removeEventListener("dispose",b)};var p=b;f!==void 0&&f.texture.dispose();const x=o.morphAttributes.position!==void 0,_=o.morphAttributes.normal!==void 0,m=o.morphAttributes.color!==void 0,u=o.morphAttributes.position||[],w=o.morphAttributes.normal||[],E=o.morphAttributes.color||[];let A=0;x===!0&&(A=1),_===!0&&(A=2),m===!0&&(A=3);let R=o.attributes.position.count*A,y=1;R>e.maxTextureSize&&(y=Math.ceil(R/e.maxTextureSize),R=e.maxTextureSize);const D=new Float32Array(R*y*4*d),N=new oc(D,R,y,d);N.type=On,N.needsUpdate=!0;const S=A*4;for(let L=0;L<d;L++){const F=u[L],k=w[L],W=E[L],G=R*y*4*L;for(let q=0;q<F.count;q++){const j=q*S;x===!0&&(s.fromBufferAttribute(F,q),D[G+j+0]=s.x,D[G+j+1]=s.y,D[G+j+2]=s.z,D[G+j+3]=0),_===!0&&(s.fromBufferAttribute(k,q),D[G+j+4]=s.x,D[G+j+5]=s.y,D[G+j+6]=s.z,D[G+j+7]=0),m===!0&&(s.fromBufferAttribute(W,q),D[G+j+8]=s.x,D[G+j+9]=s.y,D[G+j+10]=s.z,D[G+j+11]=W.itemSize===4?s.w:1)}}f={count:d,texture:N,size:new oe(R,y)},n.set(o,f),o.addEventListener("dispose",b)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",a.morphTexture,t);else{let x=0;for(let m=0;m<c.length;m++)x+=c[m];const _=o.morphTargetsRelative?1:1-x;l.getUniforms().setValue(i,"morphTargetBaseInfluence",_),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",f.texture,t),l.getUniforms().setValue(i,"morphTargetsTextureSize",f.size)}return{update:r}}function jp(i,e,t,n){let s=new WeakMap;function r(l){const c=n.render.frame,h=l.geometry,d=e.get(l,h);if(s.get(d)!==c&&(e.update(d),s.set(d,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),s.get(l)!==c&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),s.set(l,c))),l.isSkinnedMesh){const f=l.skeleton;s.get(f)!==c&&(f.update(),s.set(f,c))}return d}function a(){s=new WeakMap}function o(l){const c=l.target;c.removeEventListener("dispose",o),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:r,dispose:a}}const wc=new wt,Ml=new gc(1,1),Rc=new oc,Cc=new nh,Pc=new pc,bl=[],Sl=[],yl=new Float32Array(16),El=new Float32Array(9),Tl=new Float32Array(4);function Xi(i,e,t){const n=i[0];if(n<=0||n>0)return i;const s=e*t;let r=bl[s];if(r===void 0&&(r=new Float32Array(s),bl[s]=r),e!==0){n.toArray(r,0);for(let a=1,o=0;a!==e;++a)o+=t,i[a].toArray(r,o)}return r}function bt(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function St(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function xr(i,e){let t=Sl[e];t===void 0&&(t=new Int32Array(e),Sl[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function Qp(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function e0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(bt(t,e))return;i.uniform2fv(this.addr,e),St(t,e)}}function t0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(bt(t,e))return;i.uniform3fv(this.addr,e),St(t,e)}}function n0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(bt(t,e))return;i.uniform4fv(this.addr,e),St(t,e)}}function i0(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(bt(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),St(t,e)}else{if(bt(t,n))return;Tl.set(n),i.uniformMatrix2fv(this.addr,!1,Tl),St(t,n)}}function s0(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(bt(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),St(t,e)}else{if(bt(t,n))return;El.set(n),i.uniformMatrix3fv(this.addr,!1,El),St(t,n)}}function r0(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(bt(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),St(t,e)}else{if(bt(t,n))return;yl.set(n),i.uniformMatrix4fv(this.addr,!1,yl),St(t,n)}}function a0(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function o0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(bt(t,e))return;i.uniform2iv(this.addr,e),St(t,e)}}function l0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(bt(t,e))return;i.uniform3iv(this.addr,e),St(t,e)}}function c0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(bt(t,e))return;i.uniform4iv(this.addr,e),St(t,e)}}function u0(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function h0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(bt(t,e))return;i.uniform2uiv(this.addr,e),St(t,e)}}function d0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(bt(t,e))return;i.uniform3uiv(this.addr,e),St(t,e)}}function f0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(bt(t,e))return;i.uniform4uiv(this.addr,e),St(t,e)}}function p0(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(Ml.compareFunction=rc,r=Ml):r=wc,t.setTexture2D(e||r,s)}function m0(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture3D(e||Cc,s)}function x0(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTextureCube(e||Pc,s)}function g0(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture2DArray(e||Rc,s)}function _0(i){switch(i){case 5126:return Qp;case 35664:return e0;case 35665:return t0;case 35666:return n0;case 35674:return i0;case 35675:return s0;case 35676:return r0;case 5124:case 35670:return a0;case 35667:case 35671:return o0;case 35668:case 35672:return l0;case 35669:case 35673:return c0;case 5125:return u0;case 36294:return h0;case 36295:return d0;case 36296:return f0;case 35678:case 36198:case 36298:case 36306:case 35682:return p0;case 35679:case 36299:case 36307:return m0;case 35680:case 36300:case 36308:case 36293:return x0;case 36289:case 36303:case 36311:case 36292:return g0}}function v0(i,e){i.uniform1fv(this.addr,e)}function M0(i,e){const t=Xi(e,this.size,2);i.uniform2fv(this.addr,t)}function b0(i,e){const t=Xi(e,this.size,3);i.uniform3fv(this.addr,t)}function S0(i,e){const t=Xi(e,this.size,4);i.uniform4fv(this.addr,t)}function y0(i,e){const t=Xi(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function E0(i,e){const t=Xi(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function T0(i,e){const t=Xi(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function A0(i,e){i.uniform1iv(this.addr,e)}function w0(i,e){i.uniform2iv(this.addr,e)}function R0(i,e){i.uniform3iv(this.addr,e)}function C0(i,e){i.uniform4iv(this.addr,e)}function P0(i,e){i.uniform1uiv(this.addr,e)}function D0(i,e){i.uniform2uiv(this.addr,e)}function L0(i,e){i.uniform3uiv(this.addr,e)}function U0(i,e){i.uniform4uiv(this.addr,e)}function I0(i,e,t){const n=this.cache,s=e.length,r=xr(t,s);bt(n,r)||(i.uniform1iv(this.addr,r),St(n,r));for(let a=0;a!==s;++a)t.setTexture2D(e[a]||wc,r[a])}function N0(i,e,t){const n=this.cache,s=e.length,r=xr(t,s);bt(n,r)||(i.uniform1iv(this.addr,r),St(n,r));for(let a=0;a!==s;++a)t.setTexture3D(e[a]||Cc,r[a])}function O0(i,e,t){const n=this.cache,s=e.length,r=xr(t,s);bt(n,r)||(i.uniform1iv(this.addr,r),St(n,r));for(let a=0;a!==s;++a)t.setTextureCube(e[a]||Pc,r[a])}function F0(i,e,t){const n=this.cache,s=e.length,r=xr(t,s);bt(n,r)||(i.uniform1iv(this.addr,r),St(n,r));for(let a=0;a!==s;++a)t.setTexture2DArray(e[a]||Rc,r[a])}function B0(i){switch(i){case 5126:return v0;case 35664:return M0;case 35665:return b0;case 35666:return S0;case 35674:return y0;case 35675:return E0;case 35676:return T0;case 5124:case 35670:return A0;case 35667:case 35671:return w0;case 35668:case 35672:return R0;case 35669:case 35673:return C0;case 5125:return P0;case 36294:return D0;case 36295:return L0;case 36296:return U0;case 35678:case 36198:case 36298:case 36306:case 35682:return I0;case 35679:case 36299:case 36307:return N0;case 35680:case 36300:case 36308:case 36293:return O0;case 36289:case 36303:case 36311:case 36292:return F0}}class z0{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=_0(t.type)}}class k0{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=B0(t.type)}}class V0{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const s=this.seq;for(let r=0,a=s.length;r!==a;++r){const o=s[r];o.setValue(e,t[o.id],n)}}}const oa=/(\w+)(\])?(\[|\.)?/g;function Al(i,e){i.seq.push(e),i.map[e.id]=e}function H0(i,e,t){const n=i.name,s=n.length;for(oa.lastIndex=0;;){const r=oa.exec(n),a=oa.lastIndex;let o=r[1];const l=r[2]==="]",c=r[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===s){Al(t,c===void 0?new z0(o,i,e):new k0(o,i,e));break}else{let d=t.map[o];d===void 0&&(d=new V0(o),Al(t,d)),t=d}}}class Qs{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let s=0;s<n;++s){const r=e.getActiveUniform(t,s),a=e.getUniformLocation(t,r.name);H0(r,a,this)}}setValue(e,t,n,s){const r=this.map[t];r!==void 0&&r.setValue(e,n,s)}setOptional(e,t,n){const s=t[n];s!==void 0&&this.setValue(e,n,s)}static upload(e,t,n,s){for(let r=0,a=t.length;r!==a;++r){const o=t[r],l=n[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,s)}}static seqWithValue(e,t){const n=[];for(let s=0,r=e.length;s!==r;++s){const a=e[s];a.id in t&&n.push(a)}return n}}function wl(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const G0=37297;let W0=0;function X0(i,e){const t=i.split(`
`),n=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let a=s;a<r;a++){const o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}const Rl=new Ne;function Y0(i){Xe._getMatrix(Rl,Xe.workingColorSpace,i);const e=`mat3( ${Rl.elements.map(t=>t.toFixed(4))} )`;switch(Xe.getTransfer(i)){case ir:return[e,"LinearTransferOETF"];case Ke:return[e,"sRGBTransferOETF"];default:return Pe("WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function Cl(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),r=(i.getShaderInfoLog(e)||"").trim();if(n&&r==="")return"";const a=/ERROR: 0:(\d+)/.exec(r);if(a){const o=parseInt(a[1]);return t.toUpperCase()+`

`+r+`

`+X0(i.getShaderSource(e),o)}else return r}function q0(i,e){const t=Y0(e);return[`vec4 ${i}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}function $0(i,e){let t;switch(e){case Ru:t="Linear";break;case Cu:t="Reinhard";break;case Pu:t="Cineon";break;case Du:t="ACESFilmic";break;case Uu:t="AgX";break;case Iu:t="Neutral";break;case Lu:t="Custom";break;default:Pe("WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Xs=new M;function K0(){Xe.getLuminanceCoefficients(Xs);const i=Xs.x.toFixed(4),e=Xs.y.toFixed(4),t=Xs.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)}function j0(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(e,s),a=r.name;let o=1;r.type===i.FLOAT_MAT2&&(o=2),r.type===i.FLOAT_MAT3&&(o=3),r.type===i.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function is(i){return i!==""}function Pl(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Dl(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const Q0=/^[ \t]*#include +<([\w\d./]+)>/gm;function Qa(i){return i.replace(Q0,tm)}const em=new Map;function tm(i,e){let t=Oe[e];if(t===void 0){const n=em.get(e);if(n!==void 0)t=Oe[n],Pe('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return Qa(t)}const nm=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Ll(i){return i.replace(nm,im)}function im(i,e,t,n){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Ul(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}function sm(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Kl?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===ou?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===In&&(e="SHADOWMAP_TYPE_VSM"),e}function rm(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Bi:case zi:e="ENVMAP_TYPE_CUBE";break;case ur:e="ENVMAP_TYPE_CUBE_UV";break}return e}function am(i){let e="ENVMAP_MODE_REFLECTION";return i.envMap&&i.envMapMode===zi&&(e="ENVMAP_MODE_REFRACTION"),e}function om(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Zl:e="ENVMAP_BLENDING_MULTIPLY";break;case Au:e="ENVMAP_BLENDING_MIX";break;case wu:e="ENVMAP_BLENDING_ADD";break}return e}function lm(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function cm(i,e,t,n){const s=i.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=sm(t),c=rm(t),h=am(t),d=om(t),f=lm(t),p=Z0(t),x=J0(r),_=s.createProgram();let m,u,w=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+u);const E=w+m+a,A=w+u+o,R=wl(s,s.VERTEX_SHADER,E),y=wl(s,s.FRAGMENT_SHADER,A);s.attachShader(_,R),s.attachShader(_,y),t.index0AttributeName!==void 0?s.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(_,0,"position"),s.linkProgram(_);function D(L){if(i.debug.checkShaderErrors){const F=s.getProgramInfoLog(_)||"",k=s.getShaderInfoLog(R)||"",W=s.getShaderInfoLog(y)||"",G=F.trim(),q=k.trim(),j=W.trim();let H=!0,ne=!0;if(s.getProgramParameter(_,s.LINK_STATUS)===!1)if(H=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,_,R,y);else{const re=Cl(s,R,"vertex"),Se=Cl(s,y,"fragment");gt("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(_,s.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`};class gs{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error("THREE.Pass: .render() must be implemented in derived pass.")}dispose(){}}const ix=new yc(-1,1,1,-1,0,1);class sx extends Lt{constructor(){super(),this.setAttribute("position",new ot([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute("uv",new ot([0,2,0,0,2,0],2))}}const rx=new sx;class Lc{constructor(e){this._mesh=new ut(rx,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,ix)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}}class ax extends gs{constructor(e,t="tDiffuse"){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof Nt?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=rr.clone(e.uniforms),this.material=new Nt({name:e.name!==void 0?e.name:"unspecified",defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new Lc(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}}class Vl extends gs{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){const s=e.getContext(),r=e.state;r.buffers.color.setMask(!1),r.buffers.depth.setMask(!1),r.buffers.color.setLocked(!0),r.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),r.buffers.stencil.setTest(!0),r.buffers.stencil.setOp(s.REPLACE,s.REPLACE,s.REPLACE),r.buffers.stencil.setFunc(s.ALWAYS,a,4294967295),r.buffers.stencil.setClear(o),r.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),r.buffers.color.setLocked(!1),r.buffers.depth.setLocked(!1),r.buffers.color.setMask(!0),r.buffers.depth.setMask(!0),r.buffers.stencil.setLocked(!1),r.buffers.stencil.setFunc(s.EQUAL,1,4294967295),r.buffers.stencil.setOp(s.KEEP,s.KEEP,s.KEEP),r.buffers.stencil.setLocked(!0)}}class ox extends gs{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}}class lx{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){const n=e.getSize(new oe);this._width=n.width,this._height=n.height,t=new mn(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:En}),t.texture.name="EffectComposer.rt1"}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name="EffectComposer.rt2",this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new ax(er),this.copyPass.material.blending=yn,this.clock=new Ec}swapBuffers(){const e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){const t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){e===void 0&&(e=this.clock.getDelta());const t=this.renderer.getRenderTarget();let n=!1;for(let s=0,r=this.passes.length;s<r;s++){const a=this.passes[s];if(a.enabled!==!1){if(a.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(s),a.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),a.needsSwap){if(n){const o=this.renderer.getContext(),l=this.renderer.state.buffers.stencil;l.setFunc(o.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),l.setFunc(o.EQUAL,1,4294967295)}this.swapBuffers()}Vl!==void 0&&(a instanceof Vl?n=!0:a instanceof ox&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){const t=this.renderer.getSize(new oe);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;const n=this._width*this._pixelRatio,s=this._height*this._pixelRatio;this.renderTarget1.setSize(n,s),this.renderTarget2.setSize(n,s);for(let r=0;r<this.passes.length;r++)this.passes[r].setSize(n,s)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}}class cx extends gs{constructor(e,t,n=null,s=null,r=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=s,this.clearAlpha=r,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this._oldClearColor=new Ie}render(e,t,n){const s=e.autoClear;e.autoClear=!1;let r,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(r=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==!0&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(r),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=s}}const ux={uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new Ie(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}Hi.BlurDirectionX=new oe(1,0);Hi.BlurDirectionY=new oe(0,1);const hx=document.querySelector("#app"),Et=i=>`/corporate-site-hud-preview/${i.replace(/^\/+/,"")}`;hx.innerHTML=`
...
`;const dx=window.matchMedia("(prefers-reduced-motion: reduce)").matches,fx=document.querySelector("#command-canvas"),px=document.querySelector(".hero");document.querySelector(".hero-copy");const Hl=document.querySelector(".focus-drawer"),mx=document.querySelector(".focus-content"),xx=document.querySelector(".focus-close"),eo=document.querySelector(".modal-dismiss-layer"),un=document.querySelector(".cyber-modal"),Gi=document.querySelector(".active-panel-dock"),Uc={mission:{kicker:"ARMADA OVERVIEW / VALUE / BUSINESS / MISSION",title:"ARMADAの全体像",body:"会社になる前の空白を設計し、研究シーズをDeepTech Startupとして立ち上げる。Before Zero Theory、ARMADA Protocol、事業化プロセス、Mission、CEO Messageをまとめて読む入口です。",points:["Before Zero Theory","ARMADA Protocol","Business Process","Mission / CEO Message"],type:"mission"},deck:{kicker:"BUSINESS / WHAT WE DO",title:"DeepTech Startupを、創る。支える。新しい事業へ変える。",body:"team ARMADAは、研究の結晶である技術シーズに、成長戦略と実行力、そして日本のものづくり力をかけ合わせ、スタートアップとして量産するディープテック特化型の事業化スタジオです。",points:["Startup Creation","Startup Support","New Business Creation","Before 0から0→1まで"]},value:{kicker:"VALUE ENGINE / BEFORE ZERO THEORY / ARMADA PROTOCOL",title:"会社になる前の空白を、事業化できる仕組みに変える。",body:"Before Zero Theoryは、研究シーズが会社になる前に止まる空白を設計対象にする考え方。ARMADA Protocolは、その実践知を分岐点、判断材料、アクション、結果と学習として構造化し、次の事業化判断へ戻す仕組みです。",points:["Before Zero Theory","ARMADA Protocol","ARMADA OS","What / Why / How / Result"]},track:{kicker:"PORTFOLIO / TRACK RECORD",title:"大学・研究機関の技術を、DeepTech Startupへ。",body:"JOYCLE、LiSTie、Blue Water Energy、CrestecBio、ティエムファクトリ、Yellow Duckなど、公開可能なポートフォリオと実績を地図上のビーコンとして表示します。",points:["22 PJ / DTSU創出・支援","32億円+ / 累計資金調達","30億円+ / 助成金獲得","全省庁入札資格"]},members:{kicker:"MEMBERS / CODE NAME / PROFILE",title:"技術と事業をつなぎ、創業前から伴走する実行チーム。",body:"研究、事業開発、MOT、知財、採用、組織づくり、広報、バックオフィスまで。DeepTech Startupの立ち上げに必要な専門性を、ひとつのチームとして束ねています。",points:["KIYO","MASA","MARI","RAN","HARU","LILY","KARU","KOU","UME","ABI","KANA"],type:"members"},contact:{kicker:"CONTACT / COMPANY PROFILE",title:"研究シーズの事業化を、一緒に始める。",body:"株式会社チームアルマダ。茨城県つくば市吾妻1-10-1。2018年1月30日設立。DeepTech Startupの創出・経営、スタートアップスタジオ運営、研究機関発技術の事業化支援を行います。",points:["名前","ふりがな","会社名・団体名","メールアドレス","電話番号","投資家・VC / 企業 / メディア / その他"]}},Ic=[{code:"KIYO",name:"肥塚 恭子",kana:"こえづか きょうこ",role:"Manager",image:Et("/assets/members/kiyo.png"),bio:"セブンイレブン、飲食店数店、セントラル子供タレント、耐震構造計算設計事務所を経て、ティエムファクトリに7年在籍。その後チームアルマダへ。",skill:"場の雰囲気を盛り上げること、ものまね、掃除、植物を育てること"},{code:"MASA",name:"山地 正洋",kana:"やまじ まさひろ",role:"CEO / Founder",image:Et("/assets/members/masa-card.png"),bio:"慶應義塾大学博士号取得。NIMS、産総研、京都大学等で研究に従事。京大発SU設立、9年間経営後、CxOを多数兼任しチームアルマダを結成。",skill:"旗を振ること、みんなを巻き込むこと"},{code:"MARI",name:"吉﨑 万莉",kana:"よしざき まり",role:"MOT / DeepTech",image:Et("/assets/members/mari-card.png"),bio:"長崎北陽台、徳島大学工学博士を経てアルマダへ。",skill:"技術経営（MOT）"},{code:"RAN",name:"深山 蘭",kana:"ふかやま らん",role:"Senior Associate",image:Et("/assets/members/ran.png"),bio:"東京大学大学院修了後、産総研で11年間、法務・知財・研究支援業務に従事。熊本大学発ベンチャーCASTに3人目社員として参画し取締役COOを務める。",skill:"公的資金管理と社内制度設計"},{code:"HARU",name:"中井 遥",kana:"なかい はるか",role:"PM / Operations",image:Et("/assets/members/haru.png"),bio:"筑波大学体育専門学群卒業後、しびっくぱわーで自治体受託事業やアクセラプログラムの企画運営、採用、新規事業開発を担当。Gattoを起業。",skill:"目的達成に向けて環境を整え、道筋を明確化すること"},{code:"LILY",name:"藤崎 百合恵",kana:"ふじさき ゆりえ",role:"MOT / IP Strategy",image:Et("/assets/members/riri.png"),bio:"総合電機メーカーでプラント設計に従事後、NIMSで契約、渉外、知財戦略、研究成果PRを担当。NIMS発スタートアップの創業前からアーリー期を支援。",skill:"複雑なテーマを整理して、次の一歩を明確にすること"},{code:"KARU",name:"輕部 琢真",kana:"かるべ たくま",role:"Strategy",image:Et("/assets/members/karu.png"),bio:"東京大学、トヨタ自動車、A.T. Kearney、不動産系スタートアップなどを経てアルマダへ。",skill:"業界・技術のキャッチアップ、ディープテックSUの戦略立案・運営"},{code:"KOU",name:"宮崎 航一",kana:"みやざき こういち",role:"Business Development",image:Et("/assets/members/kou.png"),bio:"三重県出身。東京大学経済学部で経営戦略を専攻。トヨタ自動車を経て、創業期のLabBaseで科学技術領域の新規事業立ち上げやアジア展開を経験。",skill:"科学技術領域の新規事業立ち上げ"},{code:"UME",name:"梅本 隆司",kana:"うめもと りゅうじ",role:"Recruiting / PM",image:Et("/assets/members/ume.png"),bio:"大手ドラッグストア、飲食業界、人材業界、飲食業界特化の人事コンサル会社を経て独立。多数のスタートアップに採用支援として参画。",skill:"仕組み化と効率化、人の懐に入り込むこと、採用における大体のこと"},{code:"ABI",name:"安孫子 芽生",kana:"あびこ めい",role:"Organization / PM",image:Et("/assets/members/abi.png"),bio:"広告代理店で人事企画・戦略を経験後、コンサル業界、人材業界で人事、事業推進、広報、経営企画など組織づくり全般を担当。",skill:"曖昧な要素を言語化・可視化すること、誰とでも仲良くなること"},{code:"KANA",name:"夏目 奏",kana:"なつめ かな",role:"Communication / Design",image:Et("/assets/members/kana.png"),bio:"北大大学院修了。航空会社、国立極地研究所、SaaS系スタートアップを経てアルマダへ。広報、Webコンテンツ制作、紙媒体デザイン等を担う。",skill:"複雑な情報をわかりやすく伝える・届けること"}],gx={home:{position:new M(.35,10.2,9.9),lookAt:new M(.65,-1.12,0)},mission:{position:new M(-3.8,5.5,8.7),lookAt:new M(-3.8,.6,-1.4)},deck:{position:new M(2.2,5,7.6),lookAt:new M(.6,-.75,.4)},value:{position:new M(4.8,4.8,6.8),lookAt:new M(2.5,.6,-1.2)},track:{position:new M(3.05,2.35,10.6),lookAt:new M(3.05,-1.36,.25)},contact:{position:new M(-.8,4.8,7.2),lookAt:new M(1.6,-.6,-3.6)}},Gl=new M(-5,2.5,4.35),Wl=new Gt(0,0,0);let ct="home",to=!1,tn={x:0,y:0,rx:0,ry:0,hitKey:null,moved:!1},Wi=0;const en={x:0,y:0},Sn={x:0,y:0},Nc=new Map,Oc=new Map,Fc=[],Bc=[],lr=[],no=[],tr=[],_r=[],qn=[],io=[],_x=!0,nr=new M(3.05,-1.58,.45),cr={width:50.0625,height:28.265625};let fn;function zc(i){return Wc.find(e=>e.key===i)}function vx(i){const e=zc(i);return!e||i==="track"||e.plane==="ground"?"":`
  ...
  `}function Mx(i){const e=Uc[i];if(!e)return;mx.innerHTML=`
  ...
  `;const t=`
    ...
    <h2>${e.title}</h2>
  `,n=vx(i);if(Gi.innerHTML=n,Gi.classList.toggle("is-open",!!n),e.type==="members"){un.className="cyber-modal cyber-modal-members",un.innerHTML=`
      ${t}
      <p>${e.body}</p>
  ...
  `}function rn(i){if(i!=="home"&&ct!=="home"&&(Wi=Date.now()+260,i="home"),ct=i,document.body.dataset.focus=i,document.querySelectorAll("[data-focus]").forEach(e=>{e.classList.toggle("is-active",e.dataset.focus===i)}),i==="home"){Hl.classList.remove("is-open"),eo.classList.remove("is-open"),un.classList.remove("is-open"),Gi.classList.remove("is-open"),Gi.innerHTML="",document.body.removeAttribute("data-focus"),Sn.x*=.42,Sn.y*=.42;return}Mx(i),Hl.classList.remove("is-open"),eo.classList.add("is-open"),un.classList.remove("is-open"),window.setTimeout(()=>un.classList.add("is-open"),30),i==="track"&&(Sn.x=0,Sn.y=0)}document.querySelectorAll("[data-focus]").forEach(i=>{i.addEventListener("click",()=>{if(!(Date.now()<Wi)){if(ct!=="home"){rn("home");return}rn(i.dataset.focus)}})});xx.addEventListener("click",()=>rn("home"));eo.addEventListener("click",()=>rn("home"));un.addEventListener("click",i=>i.stopPropagation());un.addEventListener("pointerdown",i=>i.stopPropagation());Gi.addEventListener("click",i=>i.stopPropagation());Gi.addEventListener("pointerdown",i=>i.stopPropagation());function kc(i){if(ct==="home"||Date.now()<Wi)return;const e=i.target;e instanceof Element&&(e.closest(".cyber-modal, .active-panel-dock, .focus-close, .nav")||(i.preventDefault(),i.stopImmediatePropagation(),Wi=Date.now()+260,rn("home")))}document.addEventListener("pointerdown",kc,!0);document.addEventListener("click",kc,!0);window.addEventListener("keydown",i=>{i.key==="Escape"&&rn("home")});const Xl=new URLSearchParams(window.location.search).get("focus");Uc[Xl]&&window.setTimeout(()=>rn(Xl),250);const Yi=new mc;Yi.fog=new mo(132875,.035);const Vc=new mc,sn=new Kt(66,window.innerWidth/window.innerHeight,.1,120);sn.position.set(.35,10.2,9.9);sn.lookAt(.65,-1.12,0);const wn=new zm({canvas:fx,antialias:!0,alpha:!0,powerPreference:"high-performance"});wn.setClearColor(132875,1);wn.setClearAlpha(0);wn.setPixelRatio(Math.min(window.devicePixelRatio,1.7));wn.setSize(window.innerWidth,window.innerHeight);const fi=new lx(wn);fi.setPixelRatio(Math.min(window.devicePixelRatio,1.7));fi.setSize(window.innerWidth,window.innerHeight);fi.addPass(new cx(Yi,sn));const bx=new Hi(new oe(window.innerWidth,window.innerHeight),.95,.56,.55);fi.addPass(bx);const xn=new Hm;xn.setSize(window.innerWidth,window.innerHeight);xn.domElement.className="css3d-layer";px.appendChild(xn.domElement);xn.domElement.firstElementChild.style.pointerEvents="auto";const gn=new Wm(sn,xn.domElement);gn.enabled=_x;gn.enableDamping=!0;gn.dampingFactor=.08;gn.rotateSpeed=.62;gn.zoomSpeed=.78;gn.panSpeed=.55;gn.minDistance=3.8;gn.maxDistance=32;gn.target.copy(gx.home.lookAt);gn.update();const Sx=new Ec,Yl=new oe(0,0),at=new Vt;Yi.add(at);const pi=new Vt;Vc.add(pi);Yi.add(new Kh(7334143,.95));const Hc=new Sc(2815999,5.4,32);Hc.position.set(0,4.5,1.4);Yi.add(Hc);const Gc=new Sc(16765286,1.1,18);Gc.position.set(-5,3,-2);Yi.add(Gc);function yx({key:i,eyebrow:e,title:t,body:n,stats:s,scan:r}){const a=document.createElement("button");a.type="button",a.className=`deck-card deck-card-${i}`,a.dataset.focus=i,a.setAttribute("aria-label",`${t}を開く`);const o=r?`<span class="scan-tag">${r}</span>`:"";return i==="mission"?a.innerHTML=`
      ${o}
    ...
    `,a.addEventListener("click",l=>{if(l.stopImmediatePropagation(),!(Date.now()<Wi)){if(ct!=="home"){rn("home");return}rn(i)}}),a}function Ex(i){const e=new gr(yx(i)),t=new M(...i.position),n=new Gt(...i.rotation),s=i.scale??.012;return e.position.copy(t),e.rotation.copy(n),e.scale.setScalar(s),e.userData={key:i.key,plane:i.plane??"vertical",basePosition:t,baseRotation:n,baseScale:s,focusPosition:t.clone().add(new M(0,.15,1.15)),focusScale:s*1.18},pi.add(e),Nc.set(i.key,e),e}function pn(i,e){const t=Math.min(i,e)*.12;return[new M(-i/2+t,e/2,0),new M(i/2-t*.55,e/2,0),new M(i/2,e/2-t*.55,0),new M(i/2,-e/2+t,0),new M(i/2-t,-e/2,0),new M(-i/2+t*.45,-e/2,0),new M(-i/2,-e/2+t*.45,0),new M(-i/2,e/2-t,0),new M(-i/2+t,e/2,0)]}function it(i,e,t,n,s,r){const a=new ut(new Jt(t,n),new Tt({color:new Ie(s).multiplyScalar(1.45),transparent:!0,opacity:r,blending:Mt,depthWrite:!1,side:xt}));return a.position.set(i,e,.018),a.userData.baseOpacity=r,a.userData.kind="bar",a}function Ze(i,e=2815999,t=.56){const n=new xc(new Lt().setFromPoints(i),new go({color:new Ie(e).multiplyScalar(1.25),transparent:!0,opacity:t,blending:Mt,depthWrite:!1}));return n.userData.baseOpacity=t,n}function Ot(i,e=2815999,t=.72,n=.012){const s=new Mo(i,!1,"catmullrom",0),r=new ut(new pr(s,Math.max(8,i.length*10),n,8,!1),new Tt({color:new Ie(e).multiplyScalar(2.15),transparent:!0,opacity:t,blending:Mt,depthWrite:!1,side:xt}));return r.userData.baseOpacity=t,r.userData.kind="rail",r}function Tx(i,e,t=2815999,n=.72,s=.01){const r=e.clone().sub(i),a=r.length(),o=new ut(new _o(s,s,a,8,1,!0),new Tt({color:new Ie(t).multiplyScalar(2.2),transparent:!0,opacity:n,blending:Mt,depthWrite:!1,side:xt}));return o.position.copy(i).add(e).multiplyScalar(.5),o.quaternion.setFromUnitVectors(new M(0,1,0),r.normalize()),o.userData.baseOpacity=n,o.userData.kind="connector",o}function Ax(i,e=2815999,t=.72,n=.01){const s=new Vt;for(let r=0;r<i.length-1;r+=1)s.add(Tx(i[r],i[r+1],e,t,n));return s.userData.baseOpacity=t,s.userData.kind="segmented-rail",s}function $t(i,e,t,n,s){const r=new ut(new dr(t,24),new Tt({color:new Ie(n).multiplyScalar(1.8),transparent:!0,opacity:s,blending:Mt,depthWrite:!1,side:xt}));return r.position.set(i,e,.026),r.userData.baseOpacity=s,r.userData.kind="light",r}function Li(i,e=96){const t=[];for(let n=0;n<=e;n+=1){const s=Math.PI*2*n/e;t.push(new M(Math.cos(s)*i,Math.sin(s)*i,0))}return t}function ql(i,e){const t=i*.18,n=i*.22;return[new M(-i/2+t,e/2,0),new M(-n/2,e/2,0),new M(-n/2+i*.03,e/2-e*.035,0),new M(n/2-i*.03,e/2-e*.035,0),new M(n/2,e/2,0),new M(i/2-t,e/2,0),new M(i/2,e/2-t,0),new M(i/2,-e/2+t,0),new M(i/2-t,-e/2,0),new M(-i/2+t,-e/2,0),new M(-i/2,-e/2+t,0),new M(-i/2,e/2-t,0),new M(-i/2+t,e/2,0)]}function wx(i,e){return[new M(-i/2,e*.22,0),new M(-i*.36,e*.34,0),new M(i*.42,e*.34,0),new M(i/2,e*.18,0),new M(i*.44,-e*.28,0),new M(-i*.42,-e*.28,0),new M(-i/2,-e*.12,0),new M(-i/2,e*.22,0)]}function Rx(i,e){return[new M(-i*.2,e*.18,0),new M(i*.2,e*.18,0),new M(i*.42,-e*.18,0),new M(i*.28,-e*.5,0),new M(-i*.28,-e*.5,0),new M(-i*.42,-e*.18,0),new M(-i*.2,e*.18,0)]}function hi(i,e,t,n=36){const s=[];for(let r=0;r<=n;r+=1){const a=e+(t-e)*r/n;s.push(new M(Math.cos(a)*i,Math.sin(a)*i,0))}return s}function ss(i,e,t,n=6){const s=[];for(let r=0;r<=n;r+=1){const a=Math.PI*2*r/n;s.push(new M(i+Math.cos(a)*t,e+Math.sin(a)*t,0))}return s}function $l(i,e,t,n,s,r,a=.024){for(let o=0;o<t;o+=1){const l=Math.PI*2*o/t,c=e-n*(o%5===0?1.8:1),h=e,d=Ze([new M(Math.cos(l)*c,Math.sin(l)*c,a),new M(Math.cos(l)*h,Math.sin(l)*h,a)],s,o%5===0?r:r*.48);i.add(d)}}function Cx(i,e){return{mission:[e*430,e*300],deck:[e*520,e*230],value:[e*300,e*300],track:[e*390,e*250],members:[e*360,e*220],contact:[e*208,e*208]}[i.key]??[e*340,e*(i.stats?220:176)]}function Px(i){if(i.key==="contact")return null;const e=new M(...i.position),t=new Gt(...i.rotation),n=i.scale??.012,[s,r]=Cx(i,n),a=new Vt;let o=pn(s,r);i.key==="mission"||i.key==="value"?o=Li(Math.min(s,r)*.49,120):i.key==="contact"?o=ql(s,r):i.key==="deck"&&(o=wx(s,r));const l=i.key==="value"||i.key==="mission"?new dr(Math.min(s,r)*.46,80):new Jt(s*.96,r*.9),c=new ut(l,new Tt({color:204595,transparent:!0,opacity:i.key==="members"?0:i.key==="deck"?.12:.34,blending:Mt,depthWrite:!1,side:xt}));if(c.position.z=-.006,c.userData.baseOpacity=c.material.opacity,a.add(c),i.key!=="members"){const f=Ot(o.map(_=>_.clone().setZ(-.004)),2815999,i.key==="deck"?.1:.18,i.key==="contact"?.018:.026),p=Ot(o,7334143,i.key==="deck"?.72:.92,i.key==="contact"?.006:.008),x=Ze(o.map(_=>_.clone().multiplyScalar(1.04)),7334143,i.key==="deck"?.42:.72);x.position.z=.03,a.add(f,p,x)}const h=i.key==="value"||i.key==="mission"?Li(Math.min(s,r)*.32,96):i.key==="contact"?ql(s*.76,r*.74):i.key==="deck"?[new M(-s*.43,r*.08,0),new M(s*.43,r*.08,0)]:pn(s*.9,r*.74),d=Ze(h,2815999,.46);if(d.position.z=.014,a.add(d),i.key==="mission"&&($l(a,s*.34,24,s*.02,7334143,.52),a.add(Ze(Li(s*.17,72).map(f=>f.add(new M(-s*.32,r*.08,.02))),7334143,.72),Ze(hi(s*.43,-.35,1.08,36),2815999,.88),Ze(hi(s*.39,2.06,3.84,42),16736122,.42),$t(-s*.32,r*.08,s*.035,2815999,.9),$t(-s*.4,r*.2,s*.026,16736122,.7),$t(-s*.24,-r*.05,s*.026,2815999,.7))),i.key==="deck"){for(let f=0;f<5;f+=1){const p=-s*.38+f*s*.19;a.add(it(p,-r*.18,s*.018,r*.24,f===4?16736122:2815999,.58),Ze(pn(s*.12,r*.19).map(x=>x.add(new M(p,-r*.18,.02))),f===4?16736122:2815999,.42),$t(p,r*.14,s*.02,2815999,.72))}a.add(Ot([new M(-s*.42,r*.14,.03),new M(s*.42,r*.14,.03)],2815999,.58,.007))}if(i.key==="value"&&($l(a,s*.43,48,s*.026,7334143,.46),a.add(Ze(Li(s*.21,72),2815999,.44),Ze(hi(s*.38,-.1,.94,38),2815999,.9),Ze(hi(s*.31,1.45,2.4,32),16736122,.46),Ze([new M(-s*.43,0,.02),new M(s*.43,0,.02)],7334143,.38),Ze([new M(0,-r*.43,.02),new M(0,r*.43,.02)],7334143,.38))),i.key==="members"){for(let f=0;f<5;f+=1){const p=-s*.34+f*s*.17,x=Ze(Li(s*.038,36).map(m=>m.add(new M(p,r*.14,.028))),7334143,.74),_=Ze(Rx(s*.13,r*.38).map(m=>m.add(new M(p,-r*.1,.028))),2815999,.58);a.add(x,_,$t(p,r*.14,s*.018,2815999,.78),it(p,-r*.31,s*.1,r*.018,16736122,f%2?.36:.22))}a.add(Ot([new M(-s*.44,-r*.34,.02),new M(s*.44,-r*.34,.02)],2815999,.42,.006))}if(i.key==="contact"&&a.add(it(0,r*.4,s*.34,r*.024,2815999,.72),it(0,-r*.4,s*.28,r*.024,16736122,.62),Ze(pn(s*.78,r*.68),7334143,.38),$t(s*.28,r*.24,s*.035,16736122,.72)),i.key==="track"){a.add(it(-s*.31,r*.42,s*.22,.056,2815999,.94),it(-s*.08,r*.42,s*.08,.044,7334143,.72),it(s*.2,r*.42,s*.24,.034,2815999,.62),it(s*.4,r*.38,s*.13,.064,16736122,.96),it(-s*.38,-r*.39,s*.2,.032,2815999,.72),it(s*.14,-r*.39,s*.38,.03,2815999,.56),it(s*.44,-r*.18,.048,r*.32,7334143,.72),it(-s*.45,r*.03,.034,r*.42,2815999,.54),$t(-s*.44,r*.35,.052,2815999,.9),$t(s*.44,-r*.34,.044,16736122,.94)),[[-s*.47,r*.18,-s*.39,r*.3],[s*.48,-r*.06,s*.36,-r*.29],[-s*.12,-r*.48,s*.04,-r*.36],[-s*.42,r*.28,-s*.22,r*.28],[s*.18,-r*.28,s*.38,-r*.28]].forEach(([p,x,_,m])=>{const u=Ze([new M(p,x,.018),new M(_,m,.018)],2815999,.46);a.add(u)});for(let p=0;p<12;p+=1){const x=-s*.34+p*s*.052,_=p%3===0?.62:.32,m=it(x,r*.31,s*.026,.018,p%4===0?16736122:2815999,_);m.userData.phase=p*.37,a.add(m)}}return a.position.copy(e),a.rotation.copy(t),a.userData={key:i.key,plane:i.plane??"vertical",basePosition:e,baseRotation:t,baseScale:1,focusPosition:e.clone().add(new M(0,.15,1.15)),focusScale:1.18},at.add(a),Oc.set(i.key,a),a}function Dx(){const i=document.createElement("canvas");i.width=2048,i.height=640;const e=i.getContext("2d");e.clearRect(0,0,i.width,i.height),e.textBaseline="top",e.fillStyle="rgba(42, 247, 255, 0.14)",e.fillRect(92,86,1460,2),e.fillRect(92,492,980,2),e.fillStyle="rgba(255, 95, 122, 0.82)",e.fillRect(92,118,18,18),e.fillStyle="rgba(111, 232, 255, 0.84)",e.font='900 34px "Hiragino Sans", "Yu Gothic", sans-serif',e.fillText("SCAN 01 / MISSION PROJECTION",126,108),e.shadowColor="rgba(42, 247, 255, 0.95)",e.shadowBlur=24,e.fillStyle="rgba(234, 251, 255, 0.98)",e.font='900 116px "Hiragino Sans", "Yu Gothic", sans-serif',e.fillText("あらゆる研究シーズを、",92,178),e.fillText("事業に変える",92,310),e.shadowBlur=8,e.fillStyle="rgba(234, 251, 255, 0.72)",e.font='700 30px "Hiragino Sans", "Yu Gothic", sans-serif',e.fillText("DeepTech Startup Studio / team ARMADA",98,510);const t=new Th(i);return t.colorSpace=Pt,t.needsUpdate=!0,t}const _s=new Vt,Lx=new ut(new Jt(9.4,2.95),new Tt({map:Dx(),transparent:!0,opacity:.96,blending:Mt,depthWrite:!1,side:xt}));_s.add(Lx,Ze(pn(9.2,2.72),2815999,.36),Ze(pn(8.6,2.18),7334143,.16),it(-3.88,1.08,.62,.035,16736122,.7),it(3.52,-1.05,1.36,.026,2815999,.5));_s.position.set(-6.8,2.75,-5.35);_s.rotation.set(0,0,-.02);_s.renderOrder=20;at.add(_s);const Wc=[{key:"mission",eyebrow:"ARMADA OVERVIEW",title:"ARMADA OVERVIEW",body:"Value / Business / Mission / CEO Message",position:[-.8,1.38,-4.45],rotation:[0,0,0],plane:"screen",scale:.0128},{key:"track",eyebrow:"PORTFOLIO",title:"TRACK RECORD",stats:[["Startups","20+"],["Funding","33B+"],["Grants","30B+"],["Team","25"]],position:[6.65,1.55,5.35],rotation:[0,0,0],plane:"screen",scale:.0118},{key:"members",eyebrow:"OPERATOR ROSTER",title:"MEMBERS",body:"Code Name / Bio / Photo / Skill",position:[5.75,1.25,-4.85],rotation:[0,0,0],plane:"screen",scale:.0097},{key:"contact",eyebrow:"MAIL NODE",title:"CONTACT",body:"相談 / 会社概要",position:[7.25,-.6,6.15],rotation:[-Math.PI/2,0,0],plane:"ground",scale:.0054}];Wc.forEach(i=>{["mission","track","members"].includes(i.key)||(Ex(i),Px(i))});const Ux=[{id:"bwe",institution:"山口大学",company:"Blue Water Energy",area:"宇部市 / RED塩分濃度差発電",monogram:"BWE",anchor:[-3.05,-1.2,2.22],card:[-6.2,2.28,5]},{id:"jc",institution:"東京都港区",company:"JOYCLE",area:"東京都港区 / 廃棄物熱分解",monogram:"JC",anchor:[6.68,-1.2,.12],card:[7,2.34,5.25]},{id:"ctb",institution:"筑波大学",company:"CrestecBio",area:"つくば / 創薬",monogram:"CTB",anchor:[7.28,-1.2,-.58],card:[9.8,2.66,-2.05]},{id:"lst",institution:"QST",company:"LiSTie",area:"六ヶ所村 / リチウム資源",monogram:"LST",anchor:[8.05,-1.2,-6.58],card:[-1.65,3.18,-7.65]}];function Ix(i){const e=document.createElement("button");return e.type="button",e.className="track-site-card",e.setAttribute("aria-label",`${i.company}の実績`),e.innerHTML=`
  ...
  `,e}function Fx(i,e){const t=new Vt,n=pn(i,e),s=new ut(new Jt(i*.94,e*.84),new Tt({color:204595,transparent:!0,opacity:.32,blending:Mt,depthWrite:!1,side:xt}));return s.userData.baseOpacity=s.material.opacity,t.add(s,Ot(n.map(r=>r.clone().setZ(-.004)),2815999,.17,.024),Ot(n,7334143,.82,.007),Ze(pn(i*.88,e*.7),2815999,.36),it(-i*.32,e*.36,i*.22,.028,2815999,.62),it(i*.32,e*.33,i*.16,.038,16736122,.72),it(-i*.36,-e*.36,i*.24,.018,2815999,.42)),t}Nx.forEach(i=>{const e=new gr(Ox(i));e.position.set(...i.position),e.rotation.set(...i.rotation),e.scale.setScalar(i.scale),e.userData.key=i.key,e.element.style.opacity="0",e.element.style.pointerEvents="none",pi.add(e),Fc.push(e);const t=Fx(...i.frame);t.position.copy(e.position),t.rotation.copy(e.rotation),t.userData.key=i.key,t.visible=!1,at.add(t),Bc.push(t)});function Bx(){const i=document.createElement("article");return i.className="ground-track-modal",i.innerHTML=`
  ...
  `,i}fn=new gr(Bx());fn.position.set(2.35,-.72,3.62);fn.rotation.set(-Math.PI/2,0,0);fn.scale.setScalar(.0064);fn.element.style.opacity="0";fn.element.style.pointerEvents="none";pi.add(fn);function zx(i,e){const t=new Vt,n=pn(i,e),s=new ut(new Jt(i*.94,e*.82),new Tt({color:336954,transparent:!0,opacity:.34,blending:Mt,depthWrite:!1,side:xt}));return s.userData.baseOpacity=s.material.opacity,t.add(s),t.add(Ot(n.map(r=>r.clone().setZ(-.004)),2815999,.2,.025),Ot(n,7334143,.92,.008),Ze(pn(i*.88,e*.68),2815999,.44)),t.add(it(-i*.34,e*.37,i*.24,.036,2815999,.9),it(i*.31,e*.33,i*.15,.046,16736122,.92),it(-i*.4,-e*.34,i*.2,.024,2815999,.66),it(i*.18,-e*.34,i*.38,.022,2815999,.48),$t(-i*.43,e*.28,.042,2815999,.84)),t}Ux.forEach(i=>{const e=new gr(Ix(i));e.position.set(...i.card),e.rotation.set(0,0,0),e.scale.setScalar(.0116),e.userData.basePosition=e.position.clone(),e.userData.phase=lr.length*.5,pi.add(e),lr.push(e);const t=zx(3.86,1.28);t.position.copy(e.position),t.rotation.copy(e.rotation),t.userData.phase=e.userData.phase,t.visible=!1,t.children.forEach(l=>{l.material&&(l.material.opacity=0)}),at.add(t),no.push(t);const n=new M(...i.anchor),s=new M(...i.card).add(new M(-1.14,-.44,0)),r=Ot([n,s],2815999,.82,.016);r.renderOrder=10,r.material.opacity=0,r.visible=!1,at.add(r),tr.push(r);const a=Ot([n,s],7334143,.22,.044);a.renderOrder=9,a.material.opacity=0,a.visible=!1,at.add(a),tr.push(a);const o=new ut(new fr(.065,14,14),new Tt({color:16736122,transparent:!0,opacity:.8,blending:Mt,depthWrite:!1}));o.position.copy(n),o.userData.baseOpacity=.8,o.userData.phase=e.userData.phase,o.material.opacity=0,o.visible=!1,at.add(o),tr.push(o)});const vs=new Tc(34,68,2815999,749506);vs.material.transparent=!0;vs.material.opacity=.38;vs.position.y=-1.55;vs.visible=!1;at.add(vs);const qi=new Tc(22,22,16736122,1740774);qi.material.transparent=!0;qi.material.opacity=.08;qi.rotation.y=Math.PI/4;qi.position.y=-1.52;qi.visible=!1;at.add(qi);const yo=new Yh,vr=yo.load(Et("/assets/japan_hud_map_texture_alpha_v1_hd.png"));vr.colorSpace=Pt;vr.anisotropy=wn.capabilities.getMaxAnisotropy();const Eo=yo.load(Et("/assets/hud_ring_layer_v1.png"));Eo.colorSpace=Pt;Eo.anisotropy=wn.capabilities.getMaxAnisotropy();const To=yo.load(Et("/assets/brand/logo_only3_hud_alpha.png"));To.colorSpace=Pt;To.anisotropy=wn.capabilities.getMaxAnisotropy();const Xc=new M(.18,2.25,-5.34),Bn=new Vt;Bn.position.copy(Xc);Bn.renderOrder=18;const Mr=2.38,br=2.43;function Ao({width:i,height:e,z:t,color:n,opacity:s,scale:r=1}){const a=new ut(new Jt(i*r,e*r),new Tt({map:To,color:n,transparent:!0,opacity:s,alphaTest:.05,blending:Mt,depthWrite:!1,side:xt}));return a.position.z=t,a.userData.baseOpacity=s,Bn.add(a),_r.push(a),a}function ca(i,e){return new oe((i/730-.5)*Mr,-(e/744-.5)*br)}Ao({width:Mr,height:br,z:-.09,color:1740774,opacity:.08,scale:1.035});Ao({width:Mr,height:br,z:0,color:2815999,opacity:.11});Ao({width:Mr,height:br,z:.09,color:16777215,opacity:.06,scale:.988});const kx=[{center:ca(195.693,206.832),radius:.596,phase:0},{center:ca(524.874,346.657),radius:.596,phase:1.1},{center:ca(240.023,556.145),radius:.596,phase:2.2}];kx.forEach(({center:i,radius:e,phase:t})=>{const n=Ot(ss(i.x,i.y,e).map(o=>o.setZ(.13)),7334143,.96,.018),s=Ot(ss(i.x,i.y,e*.72).map(o=>o.setZ(.17)),2815999,.58,.008),r=Ot(ss(i.x,i.y,e).map(o=>o.setZ(-.13)),1740774,.22,.026),a=ss(i.x,i.y,e,6).slice(0,6).map(o=>{const l=Ze([o.clone().setZ(-.13),o.clone().setZ(.13)],2815999,.3);return l.userData.phase=t,l});[n,s,r,...a].forEach(o=>{o.userData.phase=t,Bn.add(o),_r.push(o)}),Bn.add($t(i.x,i.y,.045,2815999,.78),Ze(hi(e*1.18,-.12,1.08,30).map(o=>o.add(new M(i.x,i.y,.19))),7334143,.42))});[-.7,-.34,.06,.42,.76].forEach((i,e)=>{const t=Ze([new M(-1.36+e*.08,i,.22),new M(1.32-e*.04,i,.22)],e%2?7334143:16736122,e%2?.18:.12);t.userData.phase=e*.55,Bn.add(t),_r.push(t)});Bn.add(Ze(Li(1.72,120),7334143,.16),Ze(hi(1.9,-.22,1.22,54),2815999,.54),Ze(hi(1.86,2.04,3.46,54),16736122,.24));at.add(Bn);function Yc(i,e,t){const n=zc(i);if(!n)return null;const s=new M(...n.position),r=Xc.clone().add(new M(t,-.78,.04)),a=s.clone().add(new M(0,.24,.04)),o=Math.sign(a.x-r.x)||1,l=Math.sign(a.z-r.z)||1,c=r.clone().add(new M(o*.34,0,0)),h=Math.min(Math.abs(a.x-r.x)*.46,Math.abs(a.z-r.z)*.46,1.25),d=c.clone().add(new M(o*h,0,l*h)),f=new M(a.x-o*.42,a.y,a.z),p=[r,c,d,f,a],x=new M(0,.045,0);[{points:p,opacity:.62,radius:.011,lineColor:e},{points:p.map(A=>A.clone().add(x)),opacity:.24,radius:.005,lineColor:7334143},{points:p.map(A=>A.clone().sub(x)),opacity:.16,radius:.004,lineColor:2815999}].forEach((A,R)=>{const y=Ax(A.points,A.lineColor,A.opacity,A.radius);y.userData.baseOpacity=A.opacity,y.userData.phase=qn.length*.9+R*.28,y.renderOrder=17,at.add(y),qn.push(y)});const m=c.clone().lerp(d,.58),u=new Vt;u.add(Ze(ss(0,0,.08).map(A=>A.setZ(0)),e,.48),it(-.18,0,.14,.012,2815999,.42),it(.18,0,.14,.012,7334143,.32)),u.position.copy(m),u.lookAt(sn.position),u.userData.billboard=!0,u.userData.baseOpacity=.48,u.userData.phase=qn.length*.36,at.add(u),qn.push(u),[r,a].forEach((A,R)=>{const y=new ut(new fr(R===0?.07:.06,16,16),new Tt({color:R===0?e:7334143,transparent:!0,opacity:R===0?.82:.68,blending:Mt,depthWrite:!1}));y.position.copy(A),y.userData.baseOpacity=y.material.opacity,y.userData.phase=io.length*.78,y.renderOrder=18,at.add(y),io.push(y)});const w=new Vt,E=i==="mission"?.78:.64;return w.add(Ze(pn(E,.32),e,.54),it(-E*.28,.09,E*.22,.018,2815999,.48),it(E*.2,-.08,E*.3,.014,16736122,.24),$t(-E*.42,0,.026,e,.72)),w.position.copy(a.clone().add(new M(0,.1,0))),w.lookAt(sn.position),w.userData.billboard=!0,w.userData.baseOpacity=.54,w.userData.phase=qn.length*.4,at.add(w),qn.push(w),null}Yc("mission",2815999,-.48);Yc("members",7334143,.48);const Sr=new ut(new Jt(cr.width,cr.height,1,1),new Tt({map:vr,color:16777215,transparent:!0,opacity:.98,blending:Mt,depthWrite:!1,side:xt}));Sr.rotation.x=-Math.PI/2;Sr.position.copy(nr);Sr.renderOrder=2;at.add(Sr);const Ms=new ut(new Jt(cr.width*1.025,cr.height*1.025,1,1),new Tt({map:vr,color:2815999,transparent:!0,opacity:.3,blending:Mt,depthWrite:!1,side:xt}));Ms.rotation.x=-Math.PI/2;Ms.position.set(nr.x,nr.y+.03,nr.z);Ms.renderOrder=3;at.add(Ms);function qs({size:i,x:e=3.15,y:t,z:n,opacity:s,rotationZ:r,color:a,spin:o,renderOrder:l}){const c=new ut(new Jt(i,i),new Tt({map:Eo,color:a,transparent:!0,opacity:s,blending:Mt,depthWrite:!1,side:xt}));return c.rotation.set(-Math.PI/2,0,r),c.position.set(e,t,n),c.userData.spin=o,c.renderOrder=l,at.add(c),c}const Vx=[qs({size:37.6,x:3.05,y:-4.95,z:.45,opacity:.13,rotationZ:.28,color:5829631,spin:.011,renderOrder:1}),qs({size:45.2,x:3.05,y:-4.35,z:.45,opacity:.11,rotationZ:-.42,color:2815999,spin:-.008,renderOrder:1}),qs({size:53.6,x:3.05,y:-3.75,z:.45,opacity:.1,rotationZ:.08,color:8255487,spin:.006,renderOrder:1}),qs({size:60,x:3.05,y:-3.15,z:.45,opacity:.075,rotationZ:-.18,color:2815999,spin:-.004,renderOrder:1})];function ua({radius:i,centerX:e=3.15,y:t,z:n,start:s,end:r,color:a,opacity:o,tube:l,phase:c}){const h=[];for(let x=0;x<=96;x+=1){const _=s+(r-s)*(x/96);h.push(new M(e+Math.cos(_)*i,t,n+Math.sin(_)*i))}const f=new Mo(h),p=new ut(new pr(f,96,l,8,!1),new Tt({color:a,transparent:!0,opacity:o,blending:Mt,depthWrite:!1}));return p.userData.baseOpacity=o,p.userData.phase=c,p.renderOrder=8,at.add(p),p}const qc=[ua({radius:9.8,centerX:3.05,y:-2.75,z:.45,start:Math.PI*.08,end:Math.PI*.92,color:5829631,opacity:.18,tube:.018,phase:.1}),ua({radius:12.4,centerX:3.05,y:-1.05,z:.45,start:Math.PI*.1,end:Math.PI*.84,color:2815999,opacity:.12,tube:.026,phase:1.4}),ua({radius:15,centerX:3.05,y:-.62,z:.45,start:Math.PI*.16,end:Math.PI*.76,color:8255487,opacity:.075,tube:.034,phase:2.2})];qc.forEach(i=>{i.visible=!1});const yr=Ot([new M(-2.4,-1.16,2.8),new M(.7,-1.12,2),new M(3.15,-1.06,1.2),new M(5.4,-1,.12),new M(7.25,-.92,-.7)],2815999,.38,.018);yr.userData.baseOpacity=.38;yr.renderOrder=9;at.add(yr);const Hx=[[-2.4,-1.14,2.8],[.7,-1.1,2],[3.15,-1.04,1.2],[5.4,-.98,.12],[7.25,-.9,-.7]].map((i,e)=>{const t=$t(0,0,.095,e===4?16736122:2815999,e===4?.9:.72);return t.position.set(...i),t.rotation.x=-Math.PI/2,t.renderOrder=10,at.add(t),t}),Zn=Ot([new M(-2.55,-.78,-2.72),new M(.2,-.92,-1.9),new M(3.1,-.94,-1.1),new M(5.6,-.88,-.15),new M(4.45,-.78,3.1),new M(2.05,-.68,4.6)],7334143,.32,.011);Zn.userData.baseOpacity=.32;Zn.renderOrder=11;at.add(Zn);const $c=[{label:"01",position:[-2.55,-.74,-2.72],color:16736122},{label:"02",position:[5.6,-.84,-.15],color:2815999},{label:"03",position:[4.45,-.74,3.1],color:2815999},{label:"04",position:[2.05,-.64,4.6],color:16736122}].map((i,e)=>{const t=$t(0,0,e===0?.12:.09,i.color,e===0?.96:.74);return t.position.set(...i.position),t.rotation.x=-Math.PI/2,t.userData.baseOpacity=e===0?.96:.74,t.userData.phase=e*.85,t.renderOrder=12,at.add(t),t});yr.visible=!1;Hx.forEach(i=>{i.visible=!1});Zn.visible=!1;$c.forEach(i=>{i.visible=!1});window.addEventListener("pointermove",i=>{Yl.x=(i.clientX/window.innerWidth-.5)*2,Yl.y=(i.clientY/window.innerHeight-.5)*2});function Gx(i){}function Wx(i){const e=i.clientX-tn.x,t=i.clientY-tn.y;if(tn.moved=tn.moved||Math.hypot(e,t)>12,!to&&tn.hitKey){if(Math.hypot(e,t)<16)return;tn.hitKey=null;return}if(!to)return;const n=Math.max(-.95,Math.min(.95,tn.ry+e*.0045)),s=Math.max(-.38,Math.min(.38,tn.rx+t*.0032));Sn.y=n,Sn.x=s}function Kc(){if(tn.hitKey){Wi=Date.now()+260,rn(tn.hitKey),tn.hitKey=null;return}!tn.moved&&ct!=="home"&&rn("home"),to=!1,document.body.classList.remove("is-dragging-deck")}xn.domElement.addEventListener("pointerdown",Gx);xn.domElement.addEventListener("pointermove",Wx);xn.domElement.addEventListener("pointerup",Kc);xn.domElement.addEventListener("pointercancel",Kc);function Xx(){sn.aspect=window.innerWidth/window.innerHeight,sn.updateProjectionMatrix(),wn.setPixelRatio(Math.min(window.devicePixelRatio,1.7)),wn.setSize(window.innerWidth,window.innerHeight),fi.setPixelRatio(Math.min(window.devicePixelRatio,1.7)),fi.setSize(window.innerWidth,window.innerHeight),xn.setSize(window.innerWidth,window.innerHeight)}window.addEventListener("resize",Xx);let Zc=!0;document.addEventListener("visibilitychange",()=>{Zc=!document.hidden});function Jc(){if(requestAnimationFrame(Jc),!Zc)return;const i=Sx.getElapsedTime(),e=dx?.12:1;if(Sn.x=0,Sn.y=0,Ms.material.opacity=.13+Math.sin(i*1.2)*.035,Vx.forEach(n=>{n.rotation.z+=n.userData.spin*.024*e}),qc.forEach(n=>{n.material.opacity=n.userData.baseOpacity+Math.sin(i*1.05+n.userData.phase)*n.userData.baseOpacity*.18}),_r.forEach((n,s)=>{const r=.9+Math.sin(i*1.45+s*.72)*.1;if(n.material){const a=n.userData.baseOpacity??n.material.opacity;n.material.opacity=a*r}else n.traverse(a=>{if(!a.material)return;const o=a.userData.baseOpacity??a.material.opacity;a.material.opacity=o*r})}),qn.forEach(n=>{const s=.78+Math.sin(i*1.75+n.userData.phase)*.22;n.traverse(r=>{if(!r.material)return;const a=r.userData.baseOpacity??n.userData.baseOpacity??.42;r.material.opacity=a*s})}),io.forEach(n=>{const s=n.userData.baseOpacity??.5;n.material.opacity=s*(.68+Math.sin(i*2.8+n.userData.phase)*.32),n.scale.setScalar(1+Math.sin(i*2.2+n.userData.phase)*.18)}),Zn?.visible&&Zn?.material){const n=.72+Math.sin(i*1.65)*.28;Zn.material.opacity=Zn.userData.baseOpacity*n}$c.forEach(n=>{if(!n.visible||!n.material)return;const s=n.userData.baseOpacity??n.material.opacity;n.material.opacity=s*(.76+Math.sin(i*2.1+n.userData.phase)*.24)}),Nc.forEach((n,s)=>{const r=ct===s,a=ct!=="home"&&!r,o=r&&ct!=="home"&&n.userData.plane==="ground",l=r&&ct!=="home"&&!o?Gl:n.userData.basePosition,c=r&&ct!=="home"&&!o?n.userData.baseScale*.88:n.userData.baseScale;n.position.lerp(l,.075*e);const h=r&&ct!=="home"&&!o?new Gt(-en.x,-en.y,Wl.z):n.userData.baseRotation;n.rotation.x+=(h.x-n.rotation.x)*.08*e,n.rotation.y+=(h.y-n.rotation.y)*.08*e,n.rotation.z+=(h.z-n.rotation.z)*.08*e;const d=n.scale.x;n.scale.setScalar(d+(c-d)*.075*e),n.element.classList.toggle("is-active",r),n.element.classList.toggle("is-muted",a),n.element.classList.toggle("is-docked",r&&ct!=="home"&&!o)}),Oc.forEach((n,s)=>{const r=ct===s,a=ct!=="home"&&!r,o=ct==="track"&&s!=="track",l=r&&ct!=="home"&&n.userData.plane==="ground",c=r&&ct!=="home"&&!l?Gl:n.userData.basePosition,h=r&&ct!=="home"&&!l?.88:n.userData.baseScale;n.position.lerp(c,.075*e);const d=r&&ct!=="home"&&!l?new Gt(-en.x,-en.y,Wl.z):n.userData.baseRotation;n.rotation.x+=(d.x-n.rotation.x)*.08*e,n.rotation.y+=(d.y-n.rotation.y)*.08*e,n.rotation.z+=(d.z-n.rotation.z)*.08*e;const f=n.scale.x;n.scale.setScalar(f+(h-f)*.075*e),n.children.forEach(p=>{if(p.material){const x=p.userData.baseOpacity??p.material.opacity,_=p.userData.kind==="rail"?1+Math.sin(i*1.8+(n.userData.phase??0))*.12:1,u=a||o||r&&ct!=="home"&&!l?0:.58;p.material.opacity+=(u*x*_-p.material.opacity)*.08*e}})}),Fc.forEach((n,s)=>{const r=ct===n.userData.key?1:0;n.element.style.opacity="0",n.element.style.pointerEvents="none",n.element.classList.toggle("is-modal-open",r>.05);const a=Bc[s];a.visible=!1,a.children.forEach(o=>{o.material&&(o.material.opacity=0)})});const t=ct==="track"?1:0;if(fn){const n=Number(fn.element.style.opacity||0);fn.element.style.opacity=`${n+(t-n)*.08*e}`,fn.element.style.pointerEvents=t>.5?"auto":"none"}lr.forEach((n,s)=>{n.position.copy(n.userData.basePosition),n.element.style.opacity=`${Number(n.element.style.opacity||0)+(t-Number(n.element.style.opacity||0))*.08*e}`,n.element.style.pointerEvents=t>.5?"auto":"none";const r=no[s];r.visible=t>.02,r.position.copy(n.position),r.rotation.copy(n.rotation),r.children.forEach(a=>{if(a.material){const o=a.userData.baseOpacity??a.material.opacity,l=a.userData.kind==="rail"?1+Math.sin(i*2.1+n.userData.phase)*.14:1;a.material.opacity+=(o*t*l-a.material.opacity)*.1*e}})}),tr.forEach(n=>{if(!n.material)return;n.visible=t>.02;const s=n.userData.baseOpacity??.56;n.material.opacity+=(s*t*(1+Math.sin(i*2.4+(n.userData.phase??0))*.12)-n.material.opacity)*.08*e,n.geometry?.type==="SphereGeometry"&&n.scale.setScalar(1+Math.sin(i*2.2+n.userData.phase)*.16*t)}),en.x+=(Sn.x-en.x)*.08*e,en.y+=(Sn.y-en.y)*.08*e,at.rotation.x=en.x,at.rotation.y=en.y,pi.rotation.x=en.x,pi.rotation.y=en.y,gn.update(),Bn.rotation.set(0,i*.11,0),qn.forEach(n=>{n.userData.billboard&&n.lookAt(sn.position)}),lr.forEach((n,s)=>{n.quaternion.copy(sn.quaternion),no[s]?.quaternion.copy(sn.quaternion)}),fi.render(),xn.render(Vc,sn)}Jc();
